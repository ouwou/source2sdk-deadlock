...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particleslib::CParticleCollectionRendererFloatInput m_nSequenceOverride; // 0x2c10        
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x2d70        
        ...
        [[maybe_unused]] std::uint8_t pad_0x2d79[0x7]; // 0x2d79
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flMinSize; // 0x2d80        
        // metadata: MPropertyFriendlyName "maximum visual screen size"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flMaxSize; // 0x2ee0        
        // metadata: MPropertyFriendlyName "Factor to map size adjustment to alpha"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flAlphaAdjustWithSizeAdjust; // 0x3040        
        // metadata: MPropertyFriendlyName "screen size to start fading"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x31a0        
        // metadata: MPropertyFriendlyName "screen size to fade away"
        // metadata: MPropertySortPriority "1000"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x3300        
        ...
        [[maybe_unused]] std::uint8_t pad_0x346a[0x2]; // 0x346a
        ...
        [[maybe_unused]] std::uint8_t pad_0x3479[0x3]; // 0x3479
        ...
        particles::ParticleLightingQuality_t m_nLightingMode; // 0x3490        
        [[maybe_unused]] std::uint8_t pad_0x3494[0x4]; // 0x3494
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flLightingTessellation; // 0x3498        
        // metadata: MPropertyFriendlyName "lighting directionality"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != hlx"
        particleslib::CParticleCollectionRendererFloatInput m_flLightingDirectionality; // 0x35f8        
        // metadata: MPropertyFriendlyName "Particle Shadows"
        // metadata: MPropertySortPriority "400"
        // metadata: MPropertySuppressExpr "mod != csgo"
        bool m_bParticleShadows; // 0x3758        
        [[maybe_unused]] std::uint8_t pad_0x3759[0x3]; // 0x3759
        ...
        particles::CReplicationParameters m_replicationParameters; // 0x3760        
        [[maybe_unused]] std::uint8_t pad_0x4878[0x8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in C_OP_RenderSprites because it is not a standard-layout class
    static_assert(sizeof(C_OP_RenderSprites) == 0x4880);
};
