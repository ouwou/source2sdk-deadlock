...
namespace source2sdk::particles
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x2c11[0x3]; // 0x2c11
        ...
        [[maybe_unused]] std::uint8_t pad_0x2c3c[0x4]; // 0x2c3c
        ...
        particleslib::CParticleCollectionRendererFloatInput m_flTextureVWorldSize; // 0x2c40        
        // metadata: MPropertyFriendlyName "global texture V Scroll Rate"
        particleslib::CParticleCollectionRendererFloatInput m_flTextureVScrollRate; // 0x2da0        
        // metadata: MPropertyFriendlyName "global texture V Offset"
        particleslib::CParticleCollectionRendererFloatInput m_flTextureVOffset; // 0x2f00        
        ...
        [[maybe_unused]] std::uint8_t pad_0x3065[0x3]; // 0x3065
        ...
        particles::ParticleAttributeIndex_t m_nScalarFieldForTextureCoordinate; // 0x3080        
        ...
        [[maybe_unused]] std::uint8_t pad_0x308a[0x2]; // 0x308a
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x308c        
        ...
        particles::ParticleAttributeIndex_t m_nVectorFieldForOrientation; // 0x3090        
