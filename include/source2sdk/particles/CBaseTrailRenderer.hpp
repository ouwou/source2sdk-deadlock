...
namespace source2sdk::particles
{
    ...
    public:
        ...
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x2c28        
        // metadata: MPropertyFriendlyName "end fade and cull screen-size"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x2d88        
