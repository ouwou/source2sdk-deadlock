...
namespace source2sdk::particles
{
    ...
    public:
        ...
        particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x2c10        
        ...
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flStartFadeSize; // 0x2c20        
        // metadata: MPropertyFriendlyName "end fade and cull screen-size"
        // metadata: MPropertySortPriority "900"
        particleslib::CParticleCollectionRendererFloatInput m_flEndFadeSize; // 0x2d80        
