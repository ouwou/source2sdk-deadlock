...
namespace source2sdk::particles
{
    ...
    // Cannot assert offsets of fields in C_OP_RemapSDFGradientToVectorAttribute because it is not a standard-layout class
    static_assert(sizeof(C_OP_RemapSDFGradientToVectorAttribute) == 0x1c8);
};
