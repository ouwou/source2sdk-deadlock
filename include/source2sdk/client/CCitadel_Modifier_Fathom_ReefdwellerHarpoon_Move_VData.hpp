...
namespace source2sdk::client
{
    ...
    #pragma pack(push, 1)
    class CCitadel_Modifier_Fathom_ReefdwellerHarpoon_Move_VData : public client::CCitadelModifierVData
    {
    public:
        ...
        // CEmbeddedSubclass<client::CCitadelModifier> m_LatchedModifier;
