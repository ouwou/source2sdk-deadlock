...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ImmunityModifier[0x10]; // 0x1578        
        ...
        char m_FireRateModifier[0x10]; // 0x1588        
        ...
        char m_TeleportStartParticle[0xe0]; // 0x1598        
        ...
        char m_TeleportEndParticle[0xe0]; // 0x1678        
    ...
    static_assert(sizeof(CAbility_Mirage_Teleport_VData) == 0x1788);
};
