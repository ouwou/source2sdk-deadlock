...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x15a8        
        ...
        char m_TargetModifier[0x10]; // 0x1688        
        ...
        char m_FriendlyOnlyModifier[0x10]; // 0x1698        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x16a8);
};
