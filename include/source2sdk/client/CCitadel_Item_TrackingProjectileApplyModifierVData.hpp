...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x1570        
        ...
        char m_TargetModifier[0x10]; // 0x1650        
        ...
        char m_FriendlyOnlyModifier[0x10]; // 0x1660        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x1670);
};
