...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SelfModifier[0x10]; // 0x1550        
        ...
        char m_BulletAmpModifier[0x10]; // 0x1570        
        ...
        char m_ShieldModifier[0x10]; // 0x1580        
        ...
        char m_HookOutParticle[0xe0]; // 0x1590        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strHookSuccessSound; // 0x1670        
        CSoundEventName m_strHookAllySound; // 0x1680        
        CSoundEventName m_strHookMissSound; // 0x1690        
        CSoundEventName m_strHookImpactGeoSound; // 0x16a0        
        CSoundEventName m_SelfBuffCastSound; // 0x16b0        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flTrooperHitRadius; // 0x16c0        
    ...
    static_assert(sizeof(CAbilityHookVData) == 0x16c8);
};
