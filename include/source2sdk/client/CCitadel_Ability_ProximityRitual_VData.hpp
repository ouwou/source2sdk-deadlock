...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_PredatoryStatueModel[0xe0]; // 0x1560        
        ...
        char m_CatReappearParticle[0xe0]; // 0x1640        
        ...
        char m_CatDisappearParticle[0xe0]; // 0x1720        
        ...
        char m_CatEyesParticle[0xe0]; // 0x1800        
        ...
        char m_CatSummonParticle[0xe0]; // 0x18e0        
        ...
        char m_CatRecallParticle[0xe0]; // 0x19c0        
        ...
        char m_RecallLineParticle[0xe0]; // 0x1aa0        
        ...
        char m_PredatoryStatueModifier[0x10]; // 0x1ba0        
        ...
        char m_RecentDamageModifier[0x10]; // 0x1bb0        
    ...
    static_assert(sizeof(CCitadel_Ability_ProximityRitual_VData) == 0x1be0);
};
