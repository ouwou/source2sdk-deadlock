...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SwingParticle[0xe0]; // 0x660        
        ...
        char m_ReloadVisualModifier[0x10]; // 0x820        
