...
namespace source2sdk::client
{
    ...
    {
    public:
        entity2::GameTime_t m_flFlyingStartTime; // 0xc98        
        [[maybe_unused]] std::uint8_t pad_0xc9c[0xac]; // 0xc9c
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerExclusive"
        bool m_bFlying; // 0xd48        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerExclusive"
        bool m_bSummoning; // 0xd49        
        [[maybe_unused]] std::uint8_t pad_0xd4a[0x6];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Upgrade_MagicCarpet because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Upgrade_MagicCarpet) == 0xd50);
};
