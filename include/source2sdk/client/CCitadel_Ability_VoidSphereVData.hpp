...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BubbleModifier[0x10]; // 0x1568        
        ...
        char m_strCastEffect[0xe0]; // 0x1578        
