...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BarrelExplodeParticle[0xe0]; // 0x1568        
        ...
        char m_MirvExplodeParticle[0xe0]; // 0x1648        
        ...
        char m_BarrelBurnParticle[0xe0]; // 0x1728        
    ...
    static_assert(sizeof(CAbilityExplosiveBarrelVData) == 0x1868);
};
