...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BoostModifier[0x10]; // 0x15a8        
        ...
        char m_CrashModifier[0x10]; // 0x15b8        
        ...
        char m_ImmunityModifier[0x10]; // 0x15c8        
        ...
        char m_LandingBonusesModifier[0x10]; // 0x15d8        
        ...
        char m_TakeOffParticle[0xe0]; // 0x15e8        
        ...
        char m_AoEPreviewParticle[0xe0]; // 0x17a8        
        ...
        char m_nHoverParticle[0xe0]; // 0x1888        
