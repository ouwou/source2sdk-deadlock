...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hSecondPartner[0x4]; // 0xc4        
    ...
    static_assert(sizeof(CCitadel_Modifier_Mirage_DjinnsReach_Debuff) == 0x1c0);
};
