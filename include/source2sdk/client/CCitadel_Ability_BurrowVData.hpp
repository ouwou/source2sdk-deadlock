...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BurrowStartParticle[0xe0]; // 0x1648        
        ...
        char m_BurrowEndParticle[0xe0]; // 0x1728        
        ...
        char m_BurrowInGroundParticle[0xe0]; // 0x1808        
        ...
        char m_BurrowModifier[0x10]; // 0x18e8        
        ...
        char m_SpinModifier[0x10]; // 0x18f8        
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSpinStart; // 0x1920        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_BurrowVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_BurrowVData) == 0x19a8);
};
