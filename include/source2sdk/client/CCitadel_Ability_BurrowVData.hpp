...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BurrowStartParticle[0xe0]; // 0x1640        
        ...
        char m_BurrowEndParticle[0xe0]; // 0x1720        
        ...
        char m_BurrowInGroundParticle[0xe0]; // 0x1800        
        ...
        char m_BurrowModifier[0x10]; // 0x18e0        
        ...
        char m_SpinModifier[0x10]; // 0x18f0        
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSpinStart; // 0x1918        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_BurrowVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_BurrowVData) == 0x19a0);
};
