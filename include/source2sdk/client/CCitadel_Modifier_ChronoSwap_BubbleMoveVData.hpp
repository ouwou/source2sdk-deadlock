...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BeamParticle[0xe0]; // 0x5f8        
        ...
        char m_HealParticle[0xe0]; // 0x6d8        
        ...
        char m_DamageParticle[0xe0]; // 0x7b8        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_ChronoSwap_BubbleMoveVData) == 0x898);
};
