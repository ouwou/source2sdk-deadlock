...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_PreventHealingModifier[0x10]; // 0x1538        
        ...
        char m_AmbushExplosionParticle[0xe0]; // 0x1548        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_AmbushExplosionSound; // 0x1628        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Slork_InvisVData because it is not a standard-layout class
    
    static_assert(sizeof(CCitadel_Ability_Slork_InvisVData) == 0x1638);
};
