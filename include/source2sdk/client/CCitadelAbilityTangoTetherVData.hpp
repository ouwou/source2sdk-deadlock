...
namespace source2sdk::client
{
    ...
    public:
        ...
        float m_flJumpSpeed; // 0x155c        
        float m_flJumpPitch; // 0x1560        
        float m_flDashSpeed; // 0x1564        
        float m_flDashCloseEnoughToTarget; // 0x1568        
        float m_flDashLockOntoTargetDist; // 0x156c        
        float m_flVelocityTurnSpringStrength; // 0x1570        
        client::CRemapFloat m_flAngleToSpeedScale; // 0x1574        
        float m_flBackswingDuration; // 0x1584        
        float m_flAnimToStrikePointTime; // 0x1588        
        float m_flGrappleShotFloatTime; // 0x158c        
        float m_flGrappleShotDelayToFlyOnHit; // 0x1590        
        float m_flGrappleSpeed; // 0x1594        
        ...
        char m_TetherModifier[0x10]; // 0x1598        
        ...
        char m_GrappleTargetModifier[0x10]; // 0x15a8        
    ...
    static_assert(sizeof(CCitadelAbilityTangoTetherVData) == 0x1b88);
};
