...
namespace source2sdk::client
{
    ...
    public:
        ...
        Vector m_vCastStartPosition; // 0xca4        
        Vector m_vTargetPosition; // 0xcb0        
        QAngle m_vTargetAngles; // 0xcbc        
        [[maybe_unused]] std::uint8_t pad_0xcc8[0xe8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Mirage_Teleport because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Mirage_Teleport) == 0xdb0);
};
