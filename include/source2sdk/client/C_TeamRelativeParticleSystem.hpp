...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xe08[0x18]; // 0xe08
        ...
        char m_iFriendlyEffectIndex[0x8]; // 0xe30        
        // metadata: MNetworkEnable
