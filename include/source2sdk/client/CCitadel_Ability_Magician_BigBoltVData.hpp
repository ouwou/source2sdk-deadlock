...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ChargeParticle[0xe0]; // 0x1568        
        ...
        char m_ShootDelayParticle[0xe0]; // 0x1648        
        ...
        char m_CasterModifier[0x10]; // 0x1728        
        ...
        char m_BoltHitModifier[0x10]; // 0x1738        
    ...
    static_assert(sizeof(CCitadel_Ability_Magician_BigBoltVData) == 0x1768);
};
