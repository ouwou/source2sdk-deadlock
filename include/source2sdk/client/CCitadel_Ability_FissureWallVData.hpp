...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_FriendlyWallParticle[0xe0]; // 0x1568        
        ...
        char m_EnemyWallParticle[0xe0]; // 0x1648        
