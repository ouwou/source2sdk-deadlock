...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::GameTime_t m_flStartTime; // 0x860        
        // metadata: MNetworkEnable
        ...
        entity2::GameTime_t m_flNextSparkTime; // 0x87c        
        // metadata: MNetworkEnable
        client::EntityDisolveType_t m_nDissolveType; // 0x880        
        // metadata: MNetworkEnable
