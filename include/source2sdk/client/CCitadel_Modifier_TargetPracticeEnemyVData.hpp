...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BuildupCompleteModifier[0x10]; // 0x608        
        ...
        char m_BuildupModifier[0x10]; // 0x618        
        ...
        char m_TargetParticle[0xe0]; // 0x628        
        ...
        char m_HeadParticle[0xe0]; // 0x7e8        
    ...
    static_assert(sizeof(CCitadel_Modifier_TargetPracticeEnemyVData) == 0x8f8);
};
