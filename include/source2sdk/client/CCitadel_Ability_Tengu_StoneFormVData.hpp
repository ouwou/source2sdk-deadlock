...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_StoneFormParticle[0xe0]; // 0x1710        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_CastTargetSound; // 0x17f0        
        CSoundEventName m_strImpactSound; // 0x1800        
        CSoundEventName m_strFallCollideImpactSound; // 0x1810        
        ...
        char m_DragModifier[0x10]; // 0x1820        
        ...
        char m_strTrueFormModel[0xe0]; // 0x1830        
        // metadata: MPropertyStartGroup "+Stone Form Params"
        float m_flLandHoldTime; // 0x1910        
        float m_flRisingTime; // 0x1914        
        float m_flCollideRadius; // 0x1918        
    ...
    static_assert(sizeof(CCitadel_Ability_Tengu_StoneFormVData) == 0x1920);
};
