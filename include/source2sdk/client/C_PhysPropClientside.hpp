...
namespace source2sdk::client
{
    ...
    {
    public:
        entity2::GameTime_t m_flTouchDelta; // 0xce8        
        entity2::GameTime_t m_fDeathTime; // 0xcec        
        float m_inertiaScale; // 0xcf0        
        Vector m_vecDamagePosition; // 0xcf4        
        Vector m_vecDamageDirection; // 0xd00        
        client::DamageTypes_t m_nDamageType; // 0xd0c        
    ...
    static_assert(sizeof(C_PhysPropClientside) == 0xd10);
};
