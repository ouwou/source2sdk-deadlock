...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CCitadelAutoScaledTime m_flFlurryEndTime; // 0xc98        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flNextAttackTime; // 0xcb0        
        [[maybe_unused]] std::uint8_t pad_0xcb4[0x11c]; // 0xcb4
        ...
        client::SatVolumeIndex_t m_nSatVolumeIndex; // 0xdf8        
        bool m_bHasCameraOverride; // 0xdfc        
        [[maybe_unused]] std::uint8_t pad_0xdfd[0x3];
    };
    #pragma pack(pop)
