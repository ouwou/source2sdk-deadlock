...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BombParticle[0xe0]; // 0x5f8        
        ...
        char m_ExplodeDamageFriendlyParticle[0xe0]; // 0x6d8        
        ...
        char m_ExplodeDamageEnemyParticle[0xe0]; // 0x7b8        
        ...
        char m_SleepModifier[0x10]; // 0x898        
    ...
    static_assert(sizeof(CCitadel_Modifier_SleepBombVData) == 0x8b8);
};
