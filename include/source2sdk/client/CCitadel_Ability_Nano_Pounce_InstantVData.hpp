...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_FlashParticle[0xe0]; // 0x1678        
        ...
        char m_ExplodeSlowParticle[0xe0]; // 0x1838        
        ...
        char m_PrimaryHitParticle[0xe0]; // 0x1918        
    ...
    static_assert(sizeof(CCitadel_Ability_Nano_Pounce_InstantVData) == 0x1a28);
};
