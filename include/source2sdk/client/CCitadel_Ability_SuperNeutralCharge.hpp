...
namespace source2sdk::client
{
    ...
    public:
        ...
        bool m_bPreparing; // 0xe50        
        // metadata: MNetworkEnable
        bool m_bTackling; // 0xe51        
        [[maybe_unused]] std::uint8_t pad_0xe52[0x2]; // 0xe52
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flTackleStartTime; // 0xe54        
        // metadata: MNetworkEnable
        float m_flTackleDuration; // 0xe58        
        // metadata: MNetworkEnable
        Vector m_vecTackleDir; // 0xe5c        
        Vector m_vecLastPosition; // 0xe68        
        int32_t m_nStuckFramesCount; // 0xe74        
        // m_vecHitEnemies has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CUtlVector<CEntityIndex> m_vecHitEnemies;
        char m_vecHitEnemies[0x18]; // 0xe78        
        entity2::GameTime_t m_flPrepareStartTime; // 0xe90        
        client::ParticleIndex_t m_nDistancePreview; // 0xe94        
    ...
    static_assert(sizeof(CCitadel_Ability_SuperNeutralCharge) == 0xea0);
};
