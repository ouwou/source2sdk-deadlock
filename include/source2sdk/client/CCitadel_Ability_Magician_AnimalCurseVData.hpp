...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CurseModifier[0x10]; // 0x1550        
        ...
        char m_AirDampingModifier[0x10]; // 0x1560        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_TargetWarningSound; // 0x1570        
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x1580        
        ...
        char m_TargetWarningParticle[0xe0]; // 0x1660        
