...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CurseModifier[0x10]; // 0x1568        
        ...
        char m_AirDampingModifier[0x10]; // 0x1578        
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x1598        
        ...
        char m_TargetWarningParticle[0xe0]; // 0x1678        
