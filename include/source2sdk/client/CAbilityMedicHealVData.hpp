...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_HealBeamParticle[0xe0]; // 0x14f0        
        ...
        char m_HealTargetParticle[0xe0]; // 0x15d0        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strHealCastSound; // 0x16b0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityMedicHealVData because it is not a standard-layout class
    
    static_assert(sizeof(CAbilityMedicHealVData) == 0x16c0);
};
