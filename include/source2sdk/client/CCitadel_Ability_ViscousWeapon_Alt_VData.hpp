...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_strChargingParticle[0xe0]; // 0x1550        
        ...
        char m_FiringParticle[0xe0]; // 0x1710        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_ExplosionSound; // 0x17f0        
        CSoundEventName m_ChargeSound; // 0x1800        
        CSoundEventName m_ShootSound; // 0x1810        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ViscousWeapon_Alt_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ViscousWeapon_Alt_VData) == 0x1820);
};
