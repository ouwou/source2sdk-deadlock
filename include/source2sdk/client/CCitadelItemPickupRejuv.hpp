...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CCitadelAbilityComponent m_CCitadelAbilityComponent; // 0xb20        
        // metadata: MNetworkEnable
        bool m_bPickedUp; // 0xcc0        
        [[maybe_unused]] std::uint8_t pad_0xcc1[0x7];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadelItemPickupRejuv because it is not a standard-layout class
    static_assert(sizeof(CCitadelItemPickupRejuv) == 0xcc8);
};
