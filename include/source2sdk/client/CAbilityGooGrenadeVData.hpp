...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_GooGrenadeImpactModifier[0x10]; // 0x1550        
        ...
        char m_GooGrenadePuddleAuraModifier[0x10]; // 0x1560        
        ...
        char m_GooGrenadeSkipParticle[0xe0]; // 0x1570        
        ...
        char m_GooGrenadeExplodeParticle[0xe0]; // 0x1650        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_GrenadeHitImpactSound; // 0x1730        
        CSoundEventName m_GrenadeMissImpactSound; // 0x1740        
        // metadata: MPropertyStartGroup "BounceSettings"
        float m_flMinRestitution; // 0x1750        
        float m_flMaxRestitution; // 0x1754        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityGooGrenadeVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityGooGrenadeVData) == 0x1758);
};
