...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hUnlockPrereq[0x4]; // 0x9b0        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x9b7[0x9]; // 0x9b7
        entity2::GameTime_t m_flLastTouchedTime; // 0x9c0        
        Vector m_vecBeamTarget; // 0x9c4        
        Vector m_vecBeamStart; // 0x9d0        
        client::ParticleIndex_t m_nFXProgressBeam; // 0x9dc        
    ...
    static_assert(sizeof(CCitadelControlPointTrigger) == 0x9f8);
};
