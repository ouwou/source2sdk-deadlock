...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_DebrisParticle[0xe0]; // 0x630        
        ...
        char m_EnemyVisionModifier[0x10]; // 0x810        
    ...
    static_assert(sizeof(CCitadel_Modifier_FissureWallVData) == 0x830);
};
