...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SelfParticle[0xe0]; // 0x650        
        ...
        char m_AOEFriendParticle[0xe0]; // 0x730        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strAmbientLoopingLocalPlayerSound; // 0x810        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CModifierNikumanVData because it is not a standard-layout class
    static_assert(sizeof(CModifierNikumanVData) == 0x820);
};
