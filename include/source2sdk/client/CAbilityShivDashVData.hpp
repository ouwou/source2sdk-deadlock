...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_DashModifier[0x10]; // 0x1550        
        ...
        char m_DashImpactEffect[0xe0]; // 0x1560        
        ...
        char m_DashSwingEffect[0xe0]; // 0x1640        
        ...
        char m_DashLineEffect[0xe0]; // 0x1720        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strDashStartWithTargets; // 0x1800        
        CSoundEventName m_strDashStartEcho; // 0x1810        
        CSoundEventName m_strDashStartMiss; // 0x1820        
        CSoundEventName m_strDashHitEnemy; // 0x1830        
        // metadata: MPropertyStartGroup "+Dash Properties"
        float m_flEchoDelay; // 0x1840        
    ...
    static_assert(sizeof(CAbilityShivDashVData) == 0x1848);
};
