...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ChargePreviewParticle[0xe0]; // 0x1528        
        ...
        char m_ChargePrepareModifier[0x10]; // 0x1608        
        ...
        char m_ChargeActiveModifier[0x10]; // 0x1618        
        ...
        char m_DragModifier[0x10]; // 0x1638        
        // metadata: MPropertyGroupName "Sounds"
        CSoundEventName m_strHitSound; // 0x1648        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityChargedTackleVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityChargedTackleVData) == 0x1658);
};
