...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ImpactParticle[0xe0]; // 0x14f0        
        ...
        char m_SleepModifier[0x10]; // 0x15d0        
        ...
        char m_DrowsyModifier[0x10]; // 0x15e0        
