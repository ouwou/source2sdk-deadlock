...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SleepModifier[0x10]; // 0x1608        
        ...
        char m_DrowsyModifier[0x10]; // 0x1618        
