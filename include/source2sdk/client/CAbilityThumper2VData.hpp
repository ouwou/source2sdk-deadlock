...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_StompParticle[0xe0]; // 0x14f0        
        ...
        char m_BuffModifier[0x10]; // 0x15e0        
