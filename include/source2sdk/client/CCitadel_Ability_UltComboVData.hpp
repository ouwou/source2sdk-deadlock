...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_MeleeSwingParticle[0xe0]; // 0x1550        
        ...
        char m_MeleeImpactParticle[0xe0]; // 0x1630        
        ...
        char m_SelfModifier[0x10]; // 0x1710        
        ...
        char m_TargetModifier[0x10]; // 0x1720        
        ...
        char m_KillCheckModifier[0x10]; // 0x1730        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flKillCheckWindow; // 0x1740        
    ...
    static_assert(sizeof(CCitadel_Ability_UltComboVData) == 0x1748);
};
