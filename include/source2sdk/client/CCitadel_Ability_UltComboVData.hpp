...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_MeleeSwingParticle[0xe0]; // 0x1560        
        ...
        char m_MeleeImpactParticle[0xe0]; // 0x1640        
        ...
        char m_SelfModifier[0x10]; // 0x1720        
        ...
        char m_TargetModifier[0x10]; // 0x1730        
        ...
        char m_KillCheckModifier[0x10]; // 0x1740        
    ...
    static_assert(sizeof(CCitadel_Ability_UltComboVData) == 0x1758);
};
