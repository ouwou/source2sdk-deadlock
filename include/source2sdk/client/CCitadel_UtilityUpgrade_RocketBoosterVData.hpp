...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_LandingParticle[0xe0]; // 0x1688        
        ...
        char m_DropDownStartParticle[0xe0]; // 0x1848        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_DropDownStartSound; // 0x1928        
        CSoundEventName m_LandingSound; // 0x1938        
        // metadata: MPropertyStartGroup "Modifiers"
        // m_DebuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<client::CCitadelModifier> m_DebuffModifier;
        char m_DebuffModifier[0x10]; // 0x1948        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flSlamEnabledTime; // 0x1958        
    ...
    static_assert(sizeof(CCitadel_UtilityUpgrade_RocketBoosterVData) == 0x1960);
};
