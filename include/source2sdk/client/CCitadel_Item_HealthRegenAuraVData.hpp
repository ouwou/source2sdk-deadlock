...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_HealParticle[0xe0]; // 0x15a8        
        ...
        char m_CastHealParticle[0xe0]; // 0x1688        
