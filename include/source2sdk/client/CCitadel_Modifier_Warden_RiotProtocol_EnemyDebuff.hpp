...
namespace source2sdk::client
{
    ...
    // Has VTable
    #pragma pack(push, 1)
    class CCitadel_Modifier_Warden_RiotProtocol_EnemyDebuff : public client::CCitadelModifier
    {
    public:
    ...
    static_assert(sizeof(CCitadel_Modifier_Warden_RiotProtocol_EnemyDebuff) == 0xc8);
};
