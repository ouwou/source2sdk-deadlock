...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x1474[0xc]; // 0x1474
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "qangle"
        ...
        // metadata: MNetworkEnable
        client::ETier3State_t m_eAliveState; // 0x149c        
        // metadata: MNetworkEnable
        client::ETier3Phase_t m_ePhase; // 0x14a0        
    ...
    static_assert(sizeof(C_NPC_Boss_Tier3) == 0x14a8);
};
