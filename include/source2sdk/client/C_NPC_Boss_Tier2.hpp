...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x14b0[0x8]; // 0x14b0
        // metadata: MNetworkEnable
        int32_t m_iLane; // 0x14b8        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutStart; // 0x14bc        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutEnd; // 0x14c0        
        // metadata: MNetworkEnable
        ...
        char m_hTargetedEnemy[0x4]; // 0x14c4        
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "coord"
        // metadata: MNetworkChangeCallback "OnLookTargetChanged"
        Vector m_vecElectricBeamLookTarget; // 0x14c8        
        [[maybe_unused]] std::uint8_t pad_0x14d4[0xc]; // 0x14d4
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnElectricBeamCastsChanged"
        int32_t m_nElectricBeamCasts; // 0x14e0        
    ...
    static_assert(sizeof(C_NPC_Boss_Tier2) == 0x14e8);
};
