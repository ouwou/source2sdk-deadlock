...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1468[0x8]; // 0x1468
        // metadata: MNetworkEnable
        int32_t m_iLane; // 0x1470        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutStart; // 0x1474        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutEnd; // 0x1478        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(C_NPC_Boss_Tier2) == 0x14a0);
};
