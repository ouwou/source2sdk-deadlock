...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CRemapFloat m_remapAngleToTime; // 0x1578        
        ...
        char m_ImpactParticle[0xe0]; // 0x1598        
        ...
        char m_HealingSlashParticle[0xe0]; // 0x1678        
        ...
        char m_HealingSlashSwordGlow[0xe0]; // 0x1758        
    ...
    static_assert(sizeof(CCitadelAbilityHealingSlashVData) == 0x1928);
};
