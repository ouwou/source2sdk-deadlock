...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_strTargetParticleEffect[0xe0]; // 0x5f8        
        ...
        char m_strTargetEnemyParticleEffect[0xe0]; // 0x6d8        
