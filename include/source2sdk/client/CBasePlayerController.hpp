...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hPredictedPawn[0x4]; // 0x63c        
        ...
        [[maybe_unused]] std::uint8_t pad_0x700[0x68];
