...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_AllySmokeAOEModifier[0x10]; // 0x1550        
        ...
        char m_EnemySmokeAOEModifier[0x10]; // 0x1560        
