...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_AllySmokeAOEModifier[0x10]; // 0x1568        
        ...
        char m_EnemySmokeAOEModifier[0x10]; // 0x1578        
