...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CSkillInt m_nHealth; // 0x30        
        // metadata: MPropertyDescription "How damage to this part is handled."
        client::EDestructiblePartDamagePassThroughType m_nDamagePassthroughType; // 0x40        
    ...
    static_assert(offsetof(CDestructiblePartsSystemData_PartData, m_nHealth) == 0x30);
    static_assert(offsetof(CDestructiblePartsSystemData_PartData, m_nDamagePassthroughType) == 0x40);
    static_assert(offsetof(CDestructiblePartsSystemData_PartData, m_bKillNPCOnDestruction) == 0x44);
    static_assert(offsetof(CDestructiblePartsSystemData_PartData, m_sCustomDeathHandshake) == 0x48);
