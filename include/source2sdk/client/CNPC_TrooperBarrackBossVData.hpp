...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BackdoorProtectionModifier[0x10]; // 0x1810        
        ...
        char m_BackdoorBulletResistModifier[0x10]; // 0x1820        
