...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_vecLockonTargets[0x50]; // 0xdb0        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_LockOnStartTime; // 0xe00        
        [[maybe_unused]] std::uint8_t pad_0xe04[0x4]; // 0xe04
        client::ParticleIndex_t m_nTargetingLightEffect; // 0xe08        
    ...
    static_assert(sizeof(CCitadelBaseLockonAbility) == 0xe10);
};
