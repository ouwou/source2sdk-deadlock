...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_EnemyGrabModifier[0x10]; // 0x5f8        
        ...
        char m_EnemyThrowModifier[0x10]; // 0x608        
        ...
        char m_EnemyDamageModifier[0x10]; // 0x618        
        ...
        char m_InvincibleModifier[0x10]; // 0x628        
    ...
    static_assert(sizeof(CModifier_Wrecker_UltimateVData) == 0x678);
};
