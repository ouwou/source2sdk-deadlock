...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_LiftModifier[0x10]; // 0x1550        
        ...
        char m_TargetParticle[0xe0]; // 0x1560        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_TargetCastSound; // 0x1640        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityVandalOverflowVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityVandalOverflowVData) == 0x1650);
};
