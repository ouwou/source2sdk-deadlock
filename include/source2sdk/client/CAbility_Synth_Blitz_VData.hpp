...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BlitzModifier[0x10]; // 0x1550        
        ...
        char m_TechAmpModifier[0x10]; // 0x1560        
        ...
        char m_SlowParticle[0xe0]; // 0x1570        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strProcSound; // 0x1650        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbility_Synth_Blitz_VData because it is not a standard-layout class
    static_assert(sizeof(CAbility_Synth_Blitz_VData) == 0x1660);
};
