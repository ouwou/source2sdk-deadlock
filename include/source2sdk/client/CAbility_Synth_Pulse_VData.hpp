...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_EscapeModifier[0x10]; // 0x14f0        
        // m_DebuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<client::CCitadelModifier> m_DebuffModifier;
        char m_DebuffModifier[0x10]; // 0x1500        
        ...
        char m_AoEParticle[0xe0]; // 0x1510        
        ...
        char m_EffectParticle[0xe0]; // 0x15f0        
        ...
        char m_ChannelParticle[0xe0]; // 0x16d0        
        ...
        char m_HitParticle[0xe0]; // 0x17b0        
    ...
    static_assert(sizeof(CAbility_Synth_Pulse_VData) == 0x1920);
};
