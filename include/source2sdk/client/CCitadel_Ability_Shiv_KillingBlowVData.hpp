...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_KillableModifier[0x10]; // 0x1570        
        ...
        char m_ImpactParticle[0xe0]; // 0x1660        
        ...
        char m_KillingBlowCastParticle[0xe0]; // 0x1820        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_ChargeUpSound; // 0x1900        
        CSoundEventName m_OnKillSound; // 0x1910        
        // metadata: MPropertyStartGroup "+Killing Blow Params"
        float m_flPreArrivalAttackStartTime; // 0x1920        
        float m_flKillableGlowRange; // 0x1924        
        float m_flGlowMinTime; // 0x1928        
    ...
    static_assert(sizeof(CCitadel_Ability_Shiv_KillingBlowVData) == 0x1930);
};
