...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::GameTime_t m_flEndTime; // 0xb0c        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStartTime; // 0xb10        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0xb39[0xf]; // 0xb39
        // metadata: MNetworkEnable
        ...
        char m_hViewPosition[0x4]; // 0xb48        
    ...
    static_assert(sizeof(C_PointCommentaryNode) == 0xb50);
};
