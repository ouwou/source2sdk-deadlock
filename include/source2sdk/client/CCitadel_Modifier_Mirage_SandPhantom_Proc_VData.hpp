...
namespace source2sdk::client
{
    ...
    public:
        ...
        bool m_bRollOnceForAllBulletsInAShot; // 0x5f8        
        ...
        float m_flMaxBulletsToProcInShot; // 0x5fc        
        ...
        bool m_bCanProcMultipleTimesFromSameShot; // 0x600        
        // metadata: MPropertyDescription "When true, will only call OnProc if the target hit passes the unit filter."
        bool m_bRequiresTargetFilter; // 0x601        
        [[maybe_unused]] std::uint8_t pad_0x602[0x6]; // 0x602
        ...
        char m_PassiveVictimModifier[0x10]; // 0x608        
        ...
        char m_ProcReadyParticle[0xe0]; // 0x618        
        ...
        char m_TracerAdditionParticle[0xe0]; // 0x6f8        
        // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
        char m_ExplodeParticle[0xe0]; // 0x7d8        
        // metadata: MPropertyStartGroup "Sounds"
        // metadata: MPropertyDescription "Sound to play on the shooter when a bullet rolls a proc when fired."
        CSoundEventName m_OnBulletRolledProcSound; // 0x8b8        
        CSoundEventName m_ExplodeSound; // 0x8c8        
    };
    #pragma pack(pop)
