...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ProcReadyModifier[0x10]; // 0x618        
        ...
        char m_PassiveVictimModifier[0x10]; // 0x628        
        ...
        char m_ProcReadyParticle[0xe0]; // 0x638        
        ...
        char m_TracerAdditionParticle[0xe0]; // 0x718        
        // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
        char m_ExplodeParticle[0xe0]; // 0x7f8        
    ...
    static_assert(sizeof(CCitadel_Modifier_Mirage_SandPhantom_Proc_VData) == 0x908);
};
