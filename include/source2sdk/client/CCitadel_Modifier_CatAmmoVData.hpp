...
namespace source2sdk::client
{
    ...
    // Cannot assert offsets of fields in CCitadel_Modifier_CatAmmoVData because it is not a standard-layout class
    
    static_assert(sizeof(CCitadel_Modifier_CatAmmoVData) == 0x738);
};
