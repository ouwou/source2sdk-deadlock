...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SummonGangster[0x10]; // 0x5f8        
        ...
        char m_TeleportToGangster[0x10]; // 0x608        
        ...
        char m_ReplaceWithSummonGangster[0x10]; // 0x628        
        ...
        char m_ReplaceWithTeleportToGangster[0x10]; // 0x638        
        ...
        char m_ReplaceWithCancel[0x10]; // 0x648        
    };
    #pragma pack(pop)
