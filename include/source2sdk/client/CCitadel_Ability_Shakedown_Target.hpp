...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hShadowdownAbility[0x4]; // 0xc90        
        Vector m_AimPos; // 0xc94        
        [[maybe_unused]] std::uint8_t pad_0xca0[0xa8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Shakedown_Target because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Shakedown_Target) == 0xd48);
};
