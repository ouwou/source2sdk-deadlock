...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CasterOnlyTargetParticle[0xe0]; // 0x1710        
        ...
        char m_EnemyTargetedParticle[0xe0]; // 0x17f0        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strEnemyBeenTargetedSound; // 0x18d0        
        CSoundEventName m_strCasterTargetSelectedSound; // 0x18e0        
        CSoundEventName m_strFireSound; // 0x18f0        
        CSoundEventName m_strImpactSound; // 0x1900        
        CSoundEventName m_strBlockedSound; // 0x1910        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_CrimsonCannonVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Tokamak_CrimsonCannonVData) == 0x1920);
};
