...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_StompParticle[0xe0]; // 0x1550        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strStompExplosionSound; // 0x1630        
        CSoundEventName m_strCastDelayLocalPlayerSound; // 0x1640        
    ...
    static_assert(sizeof(CAbilityStompVData) == 0x1670);
};
