...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_LaserParticle[0xe0]; // 0x5f8        
        ...
        char m_PulseHitEnemyParticle[0xe0]; // 0x6d8        
