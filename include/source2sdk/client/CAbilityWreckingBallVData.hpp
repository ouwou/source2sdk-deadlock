...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SummonParticle[0xe0]; // 0x1528        
        ...
        char m_SummonReadyParticle[0xe0]; // 0x1608        
        CUtlString m_SummonParticleAttachment; // 0x16e8        
        // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
        char m_ExplodeParticle[0xe0]; // 0x16f0        
        ...
        char m_AutoThrowModifier[0x10]; // 0x17d0        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_HoldingBallLoop; // 0x17e0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityWreckingBallVData because it is not a standard-layout class
    
    static_assert(sizeof(CAbilityWreckingBallVData) == 0x17f0);
};
