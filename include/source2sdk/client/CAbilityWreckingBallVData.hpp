...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SummonParticle[0xe0]; // 0x1560        
        ...
        char m_AutoThrowModifier[0x10]; // 0x1808        
    ...
    static_assert(sizeof(CAbilityWreckingBallVData) == 0x1828);
};
