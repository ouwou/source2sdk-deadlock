...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SummonParticle[0xe0]; // 0x14f0        
        ...
        char m_AutoThrowModifier[0x10]; // 0x1798        
    ...
    static_assert(sizeof(CAbilityWreckingBallVData) == 0x17b8);
};
