...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ExplosionParticle[0xe0]; // 0x14f0        
        ...
        char m_FlameAuraParticle[0xe0]; // 0x15d0        
