...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ExplosionParticle[0xe0]; // 0x1550        
        ...
        char m_FlameAuraParticle[0xe0]; // 0x1630        
        // metadata: MPropertyLeafSuggestionProviderFn
        CGlobalSymbol m_strInFlightAnimGraphParam; // 0x1710        
