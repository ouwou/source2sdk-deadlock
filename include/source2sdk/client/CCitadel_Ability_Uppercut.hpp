...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xd10[0x230]; // 0xd10
        bool m_bShouldUseResources; // 0xf40        
        [[maybe_unused]] std::uint8_t pad_0xf41[0x7];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Uppercut because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Uppercut) == 0xf48);
};
