...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_b_KnockedDown[0x18]; // 0xf8        
        ...
        char m_b_ParryActive[0x18]; // 0x110        
        ...
        char m_b_ParrySuccess[0x18]; // 0x128        
        ...
        char m_b_PredictionError[0x18]; // 0x140        
        ...
        char m_b_PsychicLiftSelf[0x18]; // 0x158        
        ...
        char m_b_QuickReload[0x18]; // 0x170        
        ...
        char m_b_SlideGetup[0x18]; // 0x218        
        ...
        char m_b_StartGroundDash[0x18]; // 0x248        
        ...
        char m_b_ReloadingSingleRoundStart[0x18]; // 0x278        
        ...
        char m_b_ReloadingSingleRound[0x18]; // 0x290        
        ...
        char m_fl_AirDashHeading[0x18]; // 0x2a8        
        ...
        char m_fl_Crouching[0x18]; // 0x2c0        
        ...
        char m_fl_ForwardSpeed[0x18]; // 0x2d8        
        ...
        char m_fl_LookHeading[0x18]; // 0x2f0        
        ...
        char m_fl_LookPitch[0x18]; // 0x308        
        ...
        char m_fl_MeleeRandom[0x18]; // 0x320        
        ...
        char m_fl_MoveSpeed[0x18]; // 0x338        
        ...
        char m_fl_ReloadFraction[0x18]; // 0x350        
        ...
        char m_fl_ReloadTransitionTime[0x18]; // 0x368        
        ...
        char m_fl_StrafeSpeed[0x18]; // 0x380        
        ...
        char m_e_DeathSequence[0x18]; // 0x398        
        ...
        char m_e_FlinchType[0x18]; // 0x3b0        
        ...
        char m_e_FullBodySequence[0x18]; // 0x3c8        
        ...
        char m_e_GenericCast[0x18]; // 0x3e0        
        ...
        char m_e_GenericThrow[0x18]; // 0x3f8        
        ...
        char m_e_LaunchType[0x18]; // 0x410        
        ...
        char m_e_MovementType[0x18]; // 0x440        
        ...
        char m_e_SelectedAbility[0x18]; // 0x470        
        ...
        char m_e_ZiplineState[0x18]; // 0x488        
        ...
        char m_Locomotion_Facing[0x18]; // 0x4a0        
    ...
    static_assert(sizeof(CCitadelPlayerPawn_GraphController2) == 0x4d0);
};
