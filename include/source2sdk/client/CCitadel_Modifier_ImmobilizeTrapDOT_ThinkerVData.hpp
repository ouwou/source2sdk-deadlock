...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_GroundParticle[0xe0]; // 0x5f8        
    ...
    // Cannot assert offsets of fields in CCitadel_Modifier_ImmobilizeTrapDOT_ThinkerVData because it is not a standard-layout class
    
    static_assert(sizeof(CCitadel_Modifier_ImmobilizeTrapDOT_ThinkerVData) == 0x6e0);
};
