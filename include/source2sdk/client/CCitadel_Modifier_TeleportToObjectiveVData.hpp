...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_TeleportOriginParticle[0xe0]; // 0x5f8        
        ...
        char m_TeleportDestinationParticle[0xe0]; // 0x6d8        
    ...
    static_assert(sizeof(CCitadel_Modifier_TeleportToObjectiveVData) == 0x7e8);
};
