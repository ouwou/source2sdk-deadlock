...
namespace source2sdk::client
{
    ...
    public:
        ...
        float m_flMeleeInputBufferTime; // 0x1528        
        ...
        float m_flLightAttackMaxHoldTime; // 0x1534        
        client::TakeDamageFlags_t m_MeleeDamageFlags; // 0x1538        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityMeleeVData because it is not a standard-layout class
    
    static_assert(sizeof(CAbilityMeleeVData) == 0x1540);
};
