...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::CEntityIOOutput m_pOutputOnSpawned; // 0x588        
        client::PointTemplateClientOnlyEntityBehavior_t m_clientOnlyEntityBehavior; // 0x5b0        
        client::PointTemplateOwnerSpawnGroupType_t m_ownerSpawnGroupType; // 0x5b4        
    ...
    static_assert(sizeof(CPointTemplate) == 0x5f8);
};
