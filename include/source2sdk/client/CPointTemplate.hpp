...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::PointTemplateClientOnlyEntityBehavior_t m_clientOnlyEntityBehavior; // 0x588        
        client::PointTemplateOwnerSpawnGroupType_t m_ownerSpawnGroupType; // 0x58c        
        ...
        char m_createdSpawnGroupHandles[0x18]; // 0x590        
        ...
        char m_SpawnedEntityHandles[0x18]; // 0x5a8        
    ...
    static_assert(sizeof(CPointTemplate) == 0x5d0);
};
