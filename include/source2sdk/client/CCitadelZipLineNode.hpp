...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x858[0x40]; // 0x858
        ...
        char m_vecConnections[0x18]; // 0x898        
        // metadata: MNetworkEnable
        ...
        char m_hGuardingBoss[0x4]; // 0x8bc        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CCitadelZipLineNode) == 0x8c8);
};
