...
namespace source2sdk::client
{
    ...
    {
    public:
        client::CBreakableStageHelper m_stages; // 0xae8        
        entity2::CEntityIOOutput m_OnTakeDamage; // 0xb00        
        entity2::CEntityIOOutput m_OnFinalBreak; // 0xb28        
        entity2::CEntityIOOutput m_OnStageAdvanced; // 0xb50        
    ...
    static_assert(sizeof(CPropAnimatingBreakable) == 0xb78);
};
