...
namespace source2sdk::client
{
    ...
    {
    public:
        client::CBreakableStageHelper m_stages; // 0xb08        
        entity2::CEntityIOOutput m_OnTakeDamage; // 0xb20        
        entity2::CEntityIOOutput m_OnFinalBreak; // 0xb48        
        entity2::CEntityIOOutput m_OnStageAdvanced; // 0xb70        
    ...
    static_assert(sizeof(CPropAnimatingBreakable) == 0xb98);
};
