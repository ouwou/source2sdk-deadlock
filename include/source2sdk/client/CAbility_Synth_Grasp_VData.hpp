...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CasterModifier[0x10]; // 0x1568        
        ...
        char m_VictimModifier[0x10]; // 0x1578        
