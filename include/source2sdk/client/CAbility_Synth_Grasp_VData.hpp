...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CasterModifier[0x10]; // 0x14f0        
        ...
        char m_VictimModifier[0x10]; // 0x1500        
