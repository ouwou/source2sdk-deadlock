...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_flReloadSpeed[0x20]; // 0x40        
        ...
        char m_bReloadingSingleRoundStart[0x20]; // 0x60        
        ...
        char m_bReloadingSingleRound[0x20]; // 0x80        
    ...
    static_assert(sizeof(CCitadel_Ability_PrimaryWeapon_GraphController) == 0x100);
};
