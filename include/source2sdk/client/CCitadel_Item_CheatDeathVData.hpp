...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_DamagePulseParticle[0xe0]; // 0x1588        
        ...
        char m_DamageTargetParticle[0xe0]; // 0x1668        
