...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SwapParticle[0xe0]; // 0x14f0        
        ...
        char m_SwapModifier[0x10]; // 0x15d0        
        ...
        char m_PreCastModifier[0x10]; // 0x15e0        
    ...
    static_assert(sizeof(CCitadel_Ability_HealthSwapVData) == 0x1600);
};
