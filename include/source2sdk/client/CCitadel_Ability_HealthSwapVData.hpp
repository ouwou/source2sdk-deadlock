...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SwapParticle[0xe0]; // 0x1560        
        ...
        char m_SwapModifier[0x10]; // 0x1640        
        ...
        char m_PreCastModifier[0x10]; // 0x1650        
    ...
    static_assert(sizeof(CCitadel_Ability_HealthSwapVData) == 0x1670);
};
