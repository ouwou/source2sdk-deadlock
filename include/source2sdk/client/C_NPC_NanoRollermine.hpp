...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1498[0x18]; // 0x1498
        // metadata: MNetworkEnable
        float m_flForwardSpeed; // 0x14b0        
        // metadata: MNetworkEnable
