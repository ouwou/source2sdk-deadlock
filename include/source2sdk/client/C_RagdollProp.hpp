...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_hRagdollSource[0x4]; // 0xb34        
        modellib::AttachmentHandle_t m_iEyeAttachment; // 0xb38        
        ...
        char m_parentPhysicsBoneIndices[0x18]; // 0xb40        
