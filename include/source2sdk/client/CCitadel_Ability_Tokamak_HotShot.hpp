...
namespace source2sdk::client
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xc60[0x178]; // 0xc60
        float m_flDPS; // 0xdd8        
