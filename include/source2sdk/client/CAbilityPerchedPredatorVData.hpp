...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ExplodeBaseParticle[0xe0]; // 0x1568        
        ...
        char m_ExplodeFriendlyParticle[0xe0]; // 0x1648        
        ...
        char m_ExplodeEnemyParticle[0xe0]; // 0x1728        
        ...
        char m_ModifierDragEnemy[0x10]; // 0x1818        
    ...
    static_assert(sizeof(CAbilityPerchedPredatorVData) == 0x1830);
};
