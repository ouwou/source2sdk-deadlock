...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ExplodeBaseParticle[0xe0]; // 0x1550        
        ...
        char m_ExplodeFriendlyParticle[0xe0]; // 0x1630        
        ...
        char m_ExplodeEnemyParticle[0xe0]; // 0x1710        
        ...
        char m_ModifierDragEnemy[0x10]; // 0x1800        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flOnHitDetonateTimer; // 0x1810        
        float m_flTraceTravelRadius; // 0x1814        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityPerchedPredatorVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityPerchedPredatorVData) == 0x1818);
};
