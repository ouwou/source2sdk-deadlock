...
namespace source2sdk::client
{
    ...
    public:
        ...
        entity2::GameTime_t m_flParryStartTime; // 0xc98        
        // metadata: MNetworkEnable
        bool m_bAttackParried; // 0xc9c        
        [[maybe_unused]] std::uint8_t pad_0xc9d[0x3]; // 0xc9d
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flParrySuccessTime; // 0xca0        
        [[maybe_unused]] std::uint8_t pad_0xca4[0x74];
    };
    #pragma pack(pop)
