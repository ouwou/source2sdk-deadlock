...
namespace source2sdk::client
{
    ...
    public:
        ...
        CSoundEventName m_strWindupSound; // 0x1570        
        CSoundEventName m_strBeamStartSound; // 0x1580        
        CSoundEventName m_strBeamLoopSound1; // 0x1590        
        CSoundEventName m_strBeamLoopSound2; // 0x15a0        
        CSoundEventName m_strBeamStopSound; // 0x15b0        
        ...
        char m_szWeaponBeamParticle[0xe0]; // 0x15c0        
        // metadata: MPropertyStartGroup "Misc"
        float m_flWindupRepeatCycle; // 0x16a0        
        [[maybe_unused]] std::uint8_t pad_0x16a4[0x4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_PrimaryWeapon_BebopVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_PrimaryWeapon_BebopVData) == 0x16a8);
};
