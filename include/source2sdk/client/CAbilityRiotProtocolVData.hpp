...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ChargeUpParticle[0xe0]; // 0x1528        
        ...
        char m_CastDelayModifier[0x10]; // 0x16e8        
