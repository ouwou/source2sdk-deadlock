...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ZapModifier[0x10]; // 0x1550        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strHitSound; // 0x1560        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strProjectileLoopingSound; // 0x1570        
