...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BubbleParticle[0xe0]; // 0x5f8        
        ...
        char m_BubbleExplodeParticle[0xe0]; // 0x6d8        
