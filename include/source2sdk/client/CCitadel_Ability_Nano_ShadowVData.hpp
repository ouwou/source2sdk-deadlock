...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_ShadowModifier[0x10]; // 0x1568        
        ...
        char m_PurgeModifier[0x10]; // 0x1578        
    ...
    static_assert(sizeof(CCitadel_Ability_Nano_ShadowVData) == 0x15a0);
};
