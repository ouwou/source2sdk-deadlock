...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_DebuffReducedParticle[0xe0]; // 0x1538        
        ...
        char m_PurgeCastParticle[0xe0]; // 0x1618        
