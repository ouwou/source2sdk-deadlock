...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_CasterDebuffModifier[0x10]; // 0x15a8        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strExplodeSound; // 0x15b8        
        ...
        char m_CastDelayParticle[0xe0]; // 0x15c8        
        ...
        char m_TeleportTrailParticle[0xe0]; // 0x16a8        
        // metadata: MPropertyGroupName "Gameplay"
        float m_flGroundProbeSpeed; // 0x1788        
        float m_flGroundStepDown; // 0x178c        
        float m_flGroundStepUp; // 0x1790        
        int32_t m_iMaxGroundIterations; // 0x1794        
        float m_flVelocityScale; // 0x1798        
    ...
    static_assert(sizeof(CItem_WarpStone_VData) == 0x17a0);
};
