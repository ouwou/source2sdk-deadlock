...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_sAfterburnParticle[0xe0]; // 0x5f8        
        ...
        char m_sAfterburnExplodeParticle[0xe0]; // 0x6d8        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_Tokamak_HeatSinks_DOT_VData) == 0x7b8);
};
