...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BeamParticle[0xe0]; // 0x1560        
        ...
        char m_HitParticle[0xe0]; // 0x1640        
        ...
        char m_BuildupModifier[0x10]; // 0x1730        
        ...
        char m_BuildupProcModifier[0x10]; // 0x1740        
    ...
    static_assert(sizeof(CCitadel_Ability_IceBeamVData) == 0x17a0);
};
