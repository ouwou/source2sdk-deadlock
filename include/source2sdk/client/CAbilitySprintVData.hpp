...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SprintParticle[0xe0]; // 0x1550        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strSprintSound; // 0x1630        
        ...
        float m_flInCombatDuration; // 0x1640        
        float m_flSprintAccMS; // 0x1644        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilitySprintVData because it is not a standard-layout class
    static_assert(sizeof(CAbilitySprintVData) == 0x1648);
};
