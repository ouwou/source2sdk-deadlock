...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::ice_path_shard_model_desc_t m_ShardDesc; // 0x858        
        // metadata: MNetworkEnable
        QAngle m_qForward; // 0x890        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnStartTimeChanged"
        entity2::GameTime_t m_flStartTime; // 0x89c        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnEndTimeChanged"
        entity2::GameTime_t m_flEndTime; // 0x8a0        
    ...
    static_assert(sizeof(C_Citadel_Ice_Path_Shard_Physics) == 0x8a8);
};
