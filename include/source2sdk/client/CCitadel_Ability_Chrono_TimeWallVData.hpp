...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_AuraModifier[0x10]; // 0x1550        
        ...
        char m_TimeWallParticle[0xe0]; // 0x1560        
        ...
        char m_TimeWallChargeParticle[0xe0]; // 0x1640        
        ...
        char m_TimeWallHitParticle[0xe0]; // 0x1720        
        ...
        char m_TimeWallHitTimerParticle[0xe0]; // 0x1800        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strWallCreated; // 0x18e0        
        CSoundEventName m_strChargeUpSound; // 0x18f0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Chrono_TimeWallVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Chrono_TimeWallVData) == 0x1900);
};
