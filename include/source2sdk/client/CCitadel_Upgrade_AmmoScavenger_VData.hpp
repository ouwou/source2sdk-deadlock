...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BuffModifier[0x10]; // 0x1590        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_StackSound; // 0x15a0        
        CSoundEventName m_AmmoSound; // 0x15b0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Upgrade_AmmoScavenger_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Upgrade_AmmoScavenger_VData) == 0x15c0);
};
