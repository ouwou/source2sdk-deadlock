...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_AuraModifier[0x10]; // 0x1580        
        ...
        char m_DispenserModel[0xe0]; // 0x1590        
        ...
        char m_SprayParticle[0xe0]; // 0x1670        
