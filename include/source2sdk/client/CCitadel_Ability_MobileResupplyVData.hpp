...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_AuraModifier[0x10]; // 0x1508        
        ...
        char m_DispenserModel[0xe0]; // 0x1518        
        ...
        char m_SprayParticle[0xe0]; // 0x15f8        
