...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_LaserModifier[0x10]; // 0x1550        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strLaserStartSound; // 0x1560        
        CSoundEventName m_strLaserEndSound; // 0x1570        
        CSoundEventName m_strLaserLoopSound; // 0x1580        
        CSoundEventName m_strLaserHitSound; // 0x1590        
        ...
        char m_ChargeParticle[0xe0]; // 0x15a0        
        ...
        char m_BeamParticle[0xe0]; // 0x1680        
        ...
        char m_HitParticle[0xe0]; // 0x1760        
