...
namespace source2sdk::client
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0xc61[0x1c7]; // 0xc61
        bool m_bIsZoomed; // 0xe28        
        [[maybe_unused]] std::uint8_t pad_0xe29[0x27];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Tokamak_CrimsonCannon because it is not a standard-layout class
    
    static_assert(sizeof(CCitadel_Ability_Tokamak_CrimsonCannon) == 0xe50);
};
