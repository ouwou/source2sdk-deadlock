...
namespace source2sdk::client
{
    ...
    public:
        ...
        float m_flAlphaScale; // 0xdf0        
        // metadata: MNetworkEnable
        float m_flRadiusScale; // 0xdf4        
        // metadata: MNetworkEnable
        float m_flSelfIllumScale; // 0xdf8        
        // metadata: MNetworkEnable
        Color m_ColorTint; // 0xdfc        
        // metadata: MNetworkEnable
        ...
        char m_hTextureOverride[0x8]; // 0xe00        
    ...
    static_assert(sizeof(C_EnvParticleGlow) == 0xe08);
};
