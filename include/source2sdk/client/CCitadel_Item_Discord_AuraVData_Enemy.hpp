...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_strAreaEffectEnemy[0xe0]; // 0x648        
        ...
        char m_strAreaEffectFriendly[0xe0]; // 0x728        
