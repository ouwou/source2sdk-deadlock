...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_FlogParticle[0xe0]; // 0x1528        
        // metadata: MPropertyGroupName "Visuals"
        ...
        char m_FlogLifeLeachParticle[0xe0]; // 0x1608        
