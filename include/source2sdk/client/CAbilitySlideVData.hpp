...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CRemapFloat m_SlideEffectRemap; // 0x1628        
        ...
        [[maybe_unused]] std::uint8_t pad_0x167c[0x4]; // 0x167c
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x1680        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x1708        
        ...
        char m_SlideParticle[0xe0]; // 0x1790        
    ...
    static_assert(sizeof(CAbilitySlideVData) == 0x18a0);
};
