...
namespace source2sdk::client
{
    ...
    public:
        ...
        float m_flLandedFlatGroundFrictionGraceTime; // 0x1574        
        ...
        float m_flSlideActivationProbeForwardOffset; // 0x15ec        
        // metadata: MPropertyDescription "Maximum distance between probe samples"
        float m_flMaxDistanceBetweenProbeSamples; // 0x15f0        
        ...
        float m_flSampleVelDiffStdDevScaleCutoff; // 0x15fc        
        ...
        float m_flAirDragMaxAngle; // 0x160c        
        ...
        float m_flAirDragResetTime; // 0x1610        
        // metadata: MPropertyDescription "How long after you stop sliding do we consider it to still be a slide-jump."
        float m_flLateSlideJumpWindow; // 0x1614        
        // metadata: MPropertyDescription "Speed remap to slide effect intensity"
        client::CRemapFloat m_SlideEffectRemap; // 0x1618        
        // metadata: MPropertyDescription "The curve defining the getup anim's speed penalty duration(x) and severity(y)."
        CPiecewiseCurve m_GetupSpeedCurve; // 0x1628        
        // metadata: MPropertyDescription "How long after you stop sliding do we consider it to still be a slide-jump."
        float m_flGetupBusyDuration; // 0x1668        
        [[maybe_unused]] std::uint8_t pad_0x166c[0x4]; // 0x166c
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x1670        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x16f8        
        ...
        char m_SlideParticle[0xe0]; // 0x1780        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strStartSound; // 0x1860        
        CSoundEventName m_strLoopingSound; // 0x1870        
        CSoundEventName m_strStopSound; // 0x1880        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilitySlideVData because it is not a standard-layout class
    static_assert(sizeof(CAbilitySlideVData) == 0x1890);
};
