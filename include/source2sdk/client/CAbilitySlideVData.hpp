...
namespace source2sdk::client
{
    ...
    public:
        ...
        client::CRemapFloat m_SlideEffectRemap; // 0x1630        
        ...
        client::CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x1688        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x1710        
        ...
        char m_SlideParticle[0xe0]; // 0x1798        
    ...
    static_assert(sizeof(CAbilitySlideVData) == 0x18a8);
};
