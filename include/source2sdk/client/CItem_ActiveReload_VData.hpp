...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_SuccessModifier[0x10]; // 0x1588        
        ...
        char m_SuccessParticle[0xe0]; // 0x15b8        
        ...
        char m_FailureParticle[0xe0]; // 0x1698        
    ...
    static_assert(sizeof(CItem_ActiveReload_VData) == 0x1780);
};
