...
namespace source2sdk::client
{
    ...
    public:
        ...
        float m_flVerticalMoveSpeedPercent; // 0x1558        
        float m_flAirDrag; // 0x155c        
        float m_flAirAcceleration; // 0x1560        
        float m_flLaunchAirDrag; // 0x1564        
        float m_flLaunchTime; // 0x1568        
        float m_flMoveSpeedAboveBaseScale; // 0x156c        
        ...
        char m_LeapModifier[0x10]; // 0x1570        
        ...
        char m_DustParticle[0xe0]; // 0x1580        
        ...
        char m_TrailParticle[0xe0]; // 0x1660        
    ...
    static_assert(sizeof(CAbilityHornetLeapVData) == 0x1820);
};
