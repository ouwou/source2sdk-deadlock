...
namespace source2sdk::client
{
    ...
    public:
        ...
        char m_BlockerModel[0xe0]; // 0x5f8        
        ...
        char m_DomeParticle[0xe0]; // 0x6d8        
        ...
        char m_FriendlyAuraModifier[0x10]; // 0x7b8        
        ...
        char m_EnemyAuraModifier[0x10]; // 0x7c8        
    ...
    static_assert(sizeof(CCitadel_Modifier_IceDomeVData) == 0x7f8);
};
