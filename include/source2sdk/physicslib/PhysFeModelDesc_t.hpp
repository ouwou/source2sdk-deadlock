...
namespace source2sdk::physicslib
{
    ...
    static_assert(offsetof(PhysFeModelDesc_t, m_flLocalDrag1) == 0x630);
    static_assert(offsetof(PhysFeModelDesc_t, m_nRodVelocitySmoothIterations) == 0x634);
    static_assert(offsetof(PhysFeModelDesc_t, m_nQuadVelocitySmoothIterations) == 0x636);
