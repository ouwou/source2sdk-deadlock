...
namespace source2sdk::pulse_runtime_lib
{
    ...
    static_assert(offsetof(CPulse_RegisterInfo, m_OriginName) == 0x20);
    static_assert(offsetof(CPulse_RegisterInfo, m_nWrittenByInstruction) == 0x58);
    static_assert(offsetof(CPulse_RegisterInfo, m_nLastReadByInstruction) == 0x5c);
    
    static_assert(sizeof(CPulse_RegisterInfo) == 0x60);
};
