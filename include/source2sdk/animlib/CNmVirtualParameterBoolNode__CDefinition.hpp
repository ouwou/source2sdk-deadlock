...
namespace source2sdk::animlib
{
    ...
    #pragma pack(push, 1)
    class CNmVirtualParameterBoolNode__CDefinition : public animlib::CNmBoolValueNode__CDefinition
    {
    public:
    ...
    static_assert(sizeof(CNmVirtualParameterBoolNode__CDefinition) == 0x18);
};
