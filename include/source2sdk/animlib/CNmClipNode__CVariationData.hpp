...
namespace source2sdk::animlib
{
    ...
    #pragma pack(push, 1)
    class CNmClipNode__CVariationData : public animlib::CNmPoseNode__CVariationData
    {
    public:
    ...
    // Cannot assert offsets of fields in CNmClipNode::CVariationData because it is not a standard-layout class
    static_assert(sizeof(CNmClipNode__CVariationData) == 0x10);
};
