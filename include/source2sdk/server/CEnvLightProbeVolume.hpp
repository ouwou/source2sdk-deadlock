...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x4d8[0xfe0]; // 0x4d8
        ...
        [[maybe_unused]] std::uint8_t pad_0x14fd[0x3]; // 0x14fd
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x1518[0x9]; // 0x1518
        // metadata: MNetworkEnable
        bool m_Entity_bEnabled; // 0x1521        
        [[maybe_unused]] std::uint8_t pad_0x1522[0x6];
    ...
    static_assert(sizeof(CEnvLightProbeVolume) == 0x1528);
};
