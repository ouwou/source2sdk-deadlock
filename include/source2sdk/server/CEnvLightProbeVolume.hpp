...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x4e8[0xfe0]; // 0x4e8
        ...
        char m_Entity_hLightProbeTexture[0x8]; // 0x14c8        
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x1528[0x9]; // 0x1528
        // metadata: MNetworkEnable
        bool m_Entity_bEnabled; // 0x1531        
        [[maybe_unused]] std::uint8_t pad_0x1532[0x6];
    ...
    static_assert(sizeof(CEnvLightProbeVolume) == 0x1538);
};
