...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x17f0[0x8]; // 0x17f0
        // metadata: MNetworkEnable
        int32_t m_iLane; // 0x17f8        
        int32_t m_iLaneSlot; // 0x17fc        
        [[maybe_unused]] std::uint8_t pad_0x1800[0x20]; // 0x1800
        ...
        char m_hSpawnWaveController[0x4]; // 0x1820        
        ...
        char m_hTrooperSpawnPoint[0x4]; // 0x1824        
        [[maybe_unused]] std::uint8_t pad_0x1828[0x20]; // 0x1828
        ...
        char m_hNearDeathModifier[0x18]; // 0x1848        
        [[maybe_unused]] std::uint8_t pad_0x1860[0x8]; // 0x1860
        // metadata: MNetworkEnable
        ...
        char m_hTargetedEnemy[0x4]; // 0x1868        
        // metadata: MNetworkEnable
        // metadata: MNetworkBitCount "8"
        // metadata: MNetworkMinValue "0.000000"
        // metadata: MNetworkMaxValue "1.000000"
        float m_flHealingChargeParticlePct; // 0x186c        
        [[maybe_unused]] std::uint8_t pad_0x1870[0x98];
    ...
    static_assert(sizeof(CNPC_Trooper) == 0x1908);
};
