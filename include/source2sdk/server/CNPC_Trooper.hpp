...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_iLane; // 0x1610        
        int32_t m_iLaneSlot; // 0x1614        
        [[maybe_unused]] std::uint8_t pad_0x1618[0x20]; // 0x1618
        ...
        char m_hSpawnWaveController[0x4]; // 0x1638        
        ...
        char m_hTrooperSpawnPoint[0x4]; // 0x163c        
        [[maybe_unused]] std::uint8_t pad_0x1640[0x20]; // 0x1640
        ...
        char m_hNearDeathModifier[0x18]; // 0x1660        
        [[maybe_unused]] std::uint8_t pad_0x1678[0x8]; // 0x1678
        // metadata: MNetworkEnable
        ...
        char m_hTargetedEnemy[0x4]; // 0x1680        
        // metadata: MNetworkEnable
        // metadata: MNetworkBitCount "8"
        // metadata: MNetworkMinValue "0.000000"
        // metadata: MNetworkMaxValue "1.000000"
        float m_flHealingChargeParticlePct; // 0x1684        
        [[maybe_unused]] std::uint8_t pad_0x1688[0x80];
    ...
    static_assert(sizeof(CNPC_Trooper) == 0x1708);
};
