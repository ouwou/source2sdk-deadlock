...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x17e8[0x8]; // 0x17e8
        // metadata: MNetworkEnable
        int32_t m_iLane; // 0x17f0        
        int32_t m_iLaneSlot; // 0x17f4        
        [[maybe_unused]] std::uint8_t pad_0x17f8[0x20]; // 0x17f8
        ...
        char m_hSpawnWaveController[0x4]; // 0x1818        
        ...
        char m_hTrooperSpawnPoint[0x4]; // 0x181c        
        [[maybe_unused]] std::uint8_t pad_0x1820[0x20]; // 0x1820
        ...
        char m_hNearDeathModifier[0x18]; // 0x1840        
        ...
        char m_hTargetedEnemy[0x4]; // 0x1860        
        // metadata: MNetworkEnable
        // metadata: MNetworkBitCount "8"
        // metadata: MNetworkMinValue "0.000000"
        // metadata: MNetworkMaxValue "1.000000"
        float m_flHealingChargeParticlePct; // 0x1864        
        [[maybe_unused]] std::uint8_t pad_0x1868[0x98];
    ...
    static_assert(sizeof(CNPC_Trooper) == 0x1900);
};
