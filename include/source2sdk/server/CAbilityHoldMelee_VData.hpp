...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_mapAttacks[0x28]; // 0x1570        
        float m_flNextAttackOnParry; // 0x1598        
        float m_flParryWindow; // 0x159c        
        float m_flParryStunTime; // 0x15a0        
        float m_flParryCooldown; // 0x15a4        
        client::CRemapFloat m_AirMeleeUpScale; // 0x15a8        
        ...
        char m_HoldBeginEffect[0xe0]; // 0x15b8        
        ...
        char m_SuccessfulParryParticle[0xe0]; // 0x1698        
        ...
        char m_ParryActivateParticle[0xe0]; // 0x1778        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceHoldStart; // 0x1858        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceHitImpact; // 0x18e0        
        // metadata: MPropertyStartGroup "Sounds"
        // metadata: MPropertyDescription "Sound to play when starting the hold"
        CSoundEventName m_strHoldBegin; // 0x1968        
        CSoundEventName m_strSuccessfulParrySound; // 0x1978        
