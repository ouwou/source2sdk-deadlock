...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AbilityToTrigger[0x10]; // 0x1560        
        ...
        client::ECitadelHintFeature m_eHintFeatureToMarkUsedOnTrigger; // 0x1574        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CBaseTriggerAbilityVData because it is not a standard-layout class
    static_assert(sizeof(CBaseTriggerAbilityVData) == 0x1578);
};
