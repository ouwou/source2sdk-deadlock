...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ZipboostModifier[0x10]; // 0x1550        
        // metadata: MPropertyGroupName "Gameplay"
        float m_flTimeToActivate; // 0x1560        
        float m_flTimeForHint; // 0x1564        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ZipLineBoost_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ZipLineBoost_VData) == 0x1568);
};
