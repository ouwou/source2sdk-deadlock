...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_FlameDashModifier[0x10]; // 0x1550        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_DashBurstSound; // 0x1560        
        CSoundEventName m_ChargeHitSound; // 0x1570        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSpeedBoost; // 0x1580        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_FlameDashVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_FlameDashVData) == 0x1608);
};
