...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_MutedParticle[0xe0]; // 0x5f8        
        ...
        char m_MutedPlayerParticle[0xe0]; // 0x6d8        
