...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_MutedParticle[0xe0]; // 0x630        
        ...
        char m_MutedPlayerParticle[0xe0]; // 0x710        
