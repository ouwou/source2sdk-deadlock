...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::ELashGrappleState m_EGrappleState; // 0xc60        
        [[maybe_unused]] std::uint8_t pad_0xc61[0x3]; // 0xc61
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStateEnterTime; // 0xc64        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flNextStateTime; // 0xc68        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flBoostEndTime; // 0xc6c        
        [[maybe_unused]] std::uint8_t pad_0xc70[0x138];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Lash_Ultimate because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Lash_Ultimate) == 0xda8);
};
