...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_pszAttackLeanPosition[0x28]; // 0xa48        
    ...
    static_assert(sizeof(CNPC_TrooperNeutral_GraphController) == 0xab8);
};
