...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_pszAttackLeanPosition[0x28]; // 0x858        
    ...
    static_assert(sizeof(CNPC_TrooperNeutral_GraphController) == 0x8c8);
};
