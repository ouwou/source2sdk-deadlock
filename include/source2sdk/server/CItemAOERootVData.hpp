...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AOEParticle[0xe0]; // 0x1598        
        // metadata: MPropertyGroupName "Sounds"
        CSoundEventName m_strRootTargetSound; // 0x1678        
