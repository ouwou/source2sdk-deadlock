...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xad8[0x150]; // 0xad8
        bool m_bZoomed; // 0xc28        
        // metadata: MNetworkEnable
        bool m_bAirCast; // 0xc29        
        [[maybe_unused]] std::uint8_t pad_0xc2a[0x2]; // 0xc2a
        // metadata: MNetworkEnable
        Vector m_vBeamAimPos; // 0xc2c        
        [[maybe_unused]] std::uint8_t pad_0xc38[0x4]; // 0xc38
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CCitadel_Ability_Bebop_LaserBeam) == 0xc48);
};
