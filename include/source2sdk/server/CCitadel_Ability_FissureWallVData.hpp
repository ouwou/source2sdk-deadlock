...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_FriendlyWallParticle[0xe0]; // 0x14f0        
        ...
        char m_EnemyWallParticle[0xe0]; // 0x15d0        
