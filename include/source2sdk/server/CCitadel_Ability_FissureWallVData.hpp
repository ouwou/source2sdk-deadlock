...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_FriendlyWallParticle[0xe0]; // 0x1528        
        ...
        char m_EnemyWallParticle[0xe0]; // 0x1608        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_WallTravelSoundLoop; // 0x16e8        
