...
namespace source2sdk::server
{
    ...
    {
    public:
        CUtlSymbolLarge m_iszConnectionTarget; // 0x998        
        ...
        char m_vecConnections[0x18]; // 0x9a0        
        bool m_bConnectionsEnabled; // 0x9b8        
    ...
    static_assert(sizeof(CDynamicNavConnectionsVolume) == 0x9c0);
};
