...
namespace source2sdk::server
{
    ...
    {
    public:
        CUtlSymbolLarge m_iszFriendlyEffectName; // 0xd40        
        CUtlSymbolLarge m_iszEnemyEffectName; // 0xd48        
        ...
        char m_iFriendlyEffectIndex[0x8]; // 0xd50        
        // metadata: MNetworkEnable
