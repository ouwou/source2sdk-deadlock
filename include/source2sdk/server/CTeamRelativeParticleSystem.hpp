...
namespace source2sdk::server
{
    ...
    {
    public:
        CUtlSymbolLarge m_iszFriendlyEffectName; // 0xd18        
        CUtlSymbolLarge m_iszEnemyEffectName; // 0xd20        
        ...
        char m_iFriendlyEffectIndex[0x8]; // 0xd28        
        // metadata: MNetworkEnable
