...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AuraModifier[0x10]; // 0x1558        
        ...
        char m_DispenserModel[0xe0]; // 0x1568        
        ...
        char m_SprayParticle[0xe0]; // 0x1648        
