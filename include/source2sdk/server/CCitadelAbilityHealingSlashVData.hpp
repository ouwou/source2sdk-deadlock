...
namespace source2sdk::server
{
    ...
    {
    public:
        float m_flEffectSize; // 0x1558        
        float m_flMaxAttackAngle; // 0x155c        
        client::CRemapFloat m_remapAngleToTime; // 0x1560        
        ...
        char m_HealingSlashParticle[0xe0]; // 0x1660        
