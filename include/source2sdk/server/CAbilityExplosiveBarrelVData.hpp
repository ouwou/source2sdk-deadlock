...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BarrelExplodeParticle[0xe0]; // 0x1550        
        ...
        char m_MirvExplodeParticle[0xe0]; // 0x1630        
        ...
        char m_BarrelBurnParticle[0xe0]; // 0x1710        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strExplodeSound; // 0x17f0        
        CSoundEventName m_strMirvExplodeSound; // 0x1800        
        CSoundEventName m_strRiccochetSound; // 0x1810        
        CSoundEventName m_strBarrelSoundLp; // 0x1820        
        CSoundEventName m_strBarrelLaunchSound; // 0x1830        
        CSoundEventName m_strBarrelMeleedSound; // 0x1840        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityExplosiveBarrelVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityExplosiveBarrelVData) == 0x1850);
};
