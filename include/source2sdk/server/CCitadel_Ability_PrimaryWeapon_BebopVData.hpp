...
namespace source2sdk::server
{
    ...
    public:
        ...
        CSoundEventName m_strWindupSound; // 0x1598        
        CSoundEventName m_strBeamStartSound; // 0x15a8        
        CSoundEventName m_strBeamLoopSound1; // 0x15b8        
        CSoundEventName m_strBeamLoopSound2; // 0x15c8        
        CSoundEventName m_strBeamStopSound; // 0x15d8        
        ...
        char m_szWeaponBeamParticle[0xe0]; // 0x15e8        
        // metadata: MPropertyStartGroup "Misc"
        float m_flWindupRepeatCycle; // 0x16c8        
    ...
    static_assert(sizeof(CCitadel_Ability_PrimaryWeapon_BebopVData) == 0x16d0);
};
