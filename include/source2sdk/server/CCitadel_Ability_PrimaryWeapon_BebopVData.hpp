...
namespace source2sdk::server
{
    ...
    public:
        ...
        CSoundEventName m_strWindupSound; // 0x15a0        
        CSoundEventName m_strBeamStartSound; // 0x15b0        
        CSoundEventName m_strBeamLoopSound1; // 0x15c0        
        CSoundEventName m_strBeamLoopSound2; // 0x15d0        
        CSoundEventName m_strBeamStopSound; // 0x15e0        
        ...
        char m_szWeaponBeamParticle[0xe0]; // 0x15f0        
        // metadata: MPropertyStartGroup "Misc"
        float m_flWindupRepeatCycle; // 0x16d0        
    ...
    static_assert(sizeof(CCitadel_Ability_PrimaryWeapon_BebopVData) == 0x16d8);
};
