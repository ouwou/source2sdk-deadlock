...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AOERangeEffect[0xe0]; // 0x1588        
        ...
        char m_AnimCastEffect[0xe0]; // 0x1668        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceExplosion; // 0x1748        
