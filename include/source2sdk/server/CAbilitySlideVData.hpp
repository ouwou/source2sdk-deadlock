...
namespace source2sdk::server
{
    ...
    public:
        ...
        float m_flLandedFlatGroundFrictionGraceTime; // 0x156c        
        ...
        float m_flSlideActivationProbeForwardOffset; // 0x15e4        
        // metadata: MPropertyDescription "Maximum distance between probe samples"
        float m_flMaxDistanceBetweenProbeSamples; // 0x15e8        
        ...
        float m_flSampleVelDiffStdDevScaleCutoff; // 0x15f4        
        ...
        float m_flAirDragMaxAngle; // 0x1604        
        ...
        float m_flAirDragResetTime; // 0x1608        
        // metadata: MPropertyDescription "How long after you stop sliding do we consider it to still be a slide-jump."
        float m_flLateSlideJumpWindow; // 0x160c        
        // metadata: MPropertyDescription "Speed remap to slide effect intensity"
        client::CRemapFloat m_SlideEffectRemap; // 0x1610        
        // metadata: MPropertyDescription "The curve defining the getup anim's speed penalty duration(x) and severity(y)."
        CPiecewiseCurve m_GetupSpeedCurve; // 0x1620        
        // metadata: MPropertyDescription "How long after you stop sliding do we consider it to still be a slide-jump."
        float m_flGetupBusyDuration; // 0x1660        
        [[maybe_unused]] std::uint8_t pad_0x1664[0x4]; // 0x1664
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceStartSliding; // 0x1668        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceEndSliding; // 0x16f0        
        ...
        char m_SlideParticle[0xe0]; // 0x1778        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strStartSound; // 0x1858        
        CSoundEventName m_strLoopingSound; // 0x1868        
        CSoundEventName m_strStopSound; // 0x1878        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilitySlideVData because it is not a standard-layout class
    static_assert(sizeof(CAbilitySlideVData) == 0x1888);
};
