...
namespace source2sdk::server
{
    ...
    public:
        ...
        float m_flAlphaScale; // 0xd18        
        // metadata: MNetworkEnable
        float m_flRadiusScale; // 0xd1c        
        // metadata: MNetworkEnable
        float m_flSelfIllumScale; // 0xd20        
        // metadata: MNetworkEnable
        Color m_ColorTint; // 0xd24        
        // metadata: MNetworkEnable
        ...
        char m_hTextureOverride[0x8]; // 0xd28        
    ...
    static_assert(sizeof(CEnvParticleGlow) == 0xd30);
};
