...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xba8[0x2b0]; // 0xba8
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStartWindUpTime; // 0xe58        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flStartFiringTime; // 0xe5c        
        // metadata: MNetworkEnable
        bool m_bFiring; // 0xe60        
        [[maybe_unused]] std::uint8_t pad_0xe61[0x177];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_PrimaryWeapon_Bebop because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_PrimaryWeapon_Bebop) == 0xfd8);
};
