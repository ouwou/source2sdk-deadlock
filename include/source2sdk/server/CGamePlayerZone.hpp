...
namespace source2sdk::server
{
    ...
    {
    public:
        entity2::CEntityIOOutput m_OnPlayerInZone; // 0x7a8        
        entity2::CEntityIOOutput m_OnPlayerOutZone; // 0x7d0        
        ...
        char m_PlayersInCount[0x28]; // 0x7f8        
        ...
        char m_PlayersOutCount[0x28]; // 0x820        
    ...
    static_assert(sizeof(CGamePlayerZone) == 0x848);
};
