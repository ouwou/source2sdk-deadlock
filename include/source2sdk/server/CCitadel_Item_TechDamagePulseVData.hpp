...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_PulseParticle[0xe0]; // 0x1570        
        ...
        char m_TargetParticle[0xe0]; // 0x1650        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strPulseTickSound; // 0x1730        
        // metadata: MPropertyStartGroup "Gameplay"
        int32_t m_iMaxTargets; // 0x1740        
    ...
    static_assert(sizeof(CCitadel_Item_TechDamagePulseVData) == 0x1748);
};
