...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_PulseParticle[0xe0]; // 0x1598        
        ...
        char m_TargetParticle[0xe0]; // 0x1678        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strPulseTickSound; // 0x1758        
        // metadata: MPropertyStartGroup "Gameplay"
        int32_t m_iMaxTargets; // 0x1768        
    ...
    static_assert(sizeof(CCitadel_Item_TechDamagePulseVData) == 0x1770);
};
