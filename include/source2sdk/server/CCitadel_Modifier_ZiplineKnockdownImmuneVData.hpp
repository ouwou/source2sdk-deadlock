...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ZipLineEnemyKnockdownProtectionParticle[0xe0]; // 0x5f8        
        ...
        char m_ZipLineSelfKnockdownProtectionParticle[0xe0]; // 0x6d8        
        ...
        char m_ZipLineKnockdownProtectionStatusParticle[0xe0]; // 0x7b8        
        ...
        char m_ZipLineKnockdownProtectionStatusEnemyParticle[0xe0]; // 0x898        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_ZiplineKnockdownImmuneVData) == 0x978);
};
