...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BeamTargetParticle[0xe0]; // 0x1550        
        ...
        char m_UnitTargetParticle[0xe0]; // 0x1630        
        ...
        char m_SettingSunThinkerModifier[0x10]; // 0x1710        
        float m_flSSCameraPreviewOffset; // 0x1720        
        float m_flSSCameraPreviewSpeed; // 0x1724        
        float m_flSSCameraPreviewDistance; // 0x1728        
    ...
    static_assert(sizeof(CCitadel_Ability_SettingSun_VData) == 0x1730);
};
