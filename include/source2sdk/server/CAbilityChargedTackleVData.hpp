...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ChargePreviewParticle[0xe0]; // 0x14f0        
        ...
        char m_ChargePrepareModifier[0x10]; // 0x15d0        
        ...
        char m_ChargeActiveModifier[0x10]; // 0x15e0        
        ...
        char m_DragModifier[0x10]; // 0x1600        
    ...
    static_assert(sizeof(CAbilityChargedTackleVData) == 0x1620);
};
