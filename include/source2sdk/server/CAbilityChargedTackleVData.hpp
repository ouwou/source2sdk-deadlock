...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ChargePreviewParticle[0xe0]; // 0x1568        
        ...
        char m_ChargePrepareModifier[0x10]; // 0x1648        
        ...
        char m_ChargeActiveModifier[0x10]; // 0x1658        
        ...
        char m_DragModifier[0x10]; // 0x1668        
    ...
    static_assert(sizeof(CAbilityChargedTackleVData) == 0x1688);
};
