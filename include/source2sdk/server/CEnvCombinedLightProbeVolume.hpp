...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x4d8[0x1060]; // 0x4d8
        ...
        [[maybe_unused]] std::uint8_t pad_0x1589[0x3]; // 0x1589
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x15c4[0x15]; // 0x15c4
        // metadata: MNetworkEnable
        bool m_Entity_bEnabled; // 0x15d9        
        [[maybe_unused]] std::uint8_t pad_0x15da[0x6];
    ...
    static_assert(sizeof(CEnvCombinedLightProbeVolume) == 0x15e0);
};
