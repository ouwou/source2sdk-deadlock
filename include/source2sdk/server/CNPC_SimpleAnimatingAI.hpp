...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xa38[0x14]; // 0xa38
        ...
        server::CCitadelRegenComponent m_CCitadelRegenComponent; // 0xa50        
    ...
    static_assert(sizeof(CNPC_SimpleAnimatingAI) == 0xbd0);
};
