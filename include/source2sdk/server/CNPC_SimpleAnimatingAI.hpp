...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xa40[0x14]; // 0xa40
        ...
        server::CCitadelRegenComponent m_CCitadelRegenComponent; // 0xa58        
    ...
    static_assert(sizeof(CNPC_SimpleAnimatingAI) == 0xbd8);
};
