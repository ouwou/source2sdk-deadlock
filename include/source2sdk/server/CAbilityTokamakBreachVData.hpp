...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AllySmokeAOEModifier[0x10]; // 0x1560        
        ...
        char m_EnemySmokeAOEModifier[0x10]; // 0x1570        
