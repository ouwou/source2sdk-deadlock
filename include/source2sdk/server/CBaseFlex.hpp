...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_flexWeight[0x18]; // 0xa28        
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "coord"
        Vector m_vLookTargetPosition; // 0xa40        
        // metadata: MNetworkEnable
        bool m_blinktoggle; // 0xa4c        
        [[maybe_unused]] std::uint8_t pad_0xa4d[0x53]; // 0xa4d
        entity2::GameTime_t m_flAllowResponsesEndTime; // 0xaa0        
        entity2::GameTime_t m_flLastFlexAnimationTime; // 0xaa4        
        client::SceneEventId_t m_nNextSceneEventId; // 0xaa8        
        bool m_bUpdateLayerPriorities; // 0xaac        
        [[maybe_unused]] std::uint8_t pad_0xaad[0xb];
    ...
    static_assert(sizeof(CBaseFlex) == 0xab8);
};
