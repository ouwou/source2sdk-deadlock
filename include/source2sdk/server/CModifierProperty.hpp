...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x34[0x163]; // 0x34
        uint8_t m_nProviderVisitedFlags; // 0x197        
        bool m_bModifierStatesDirty; // 0x198        
        bool m_bPredictedOwner; // 0x199        
        int8_t m_iLockRefCount; // 0x19a        
        [[maybe_unused]] std::uint8_t pad_0x19b[0x1]; // 0x19b
    ...
    static_assert(offsetof(CModifierProperty, m_nProviderVisitedFlags) == 0x197);
    static_assert(offsetof(CModifierProperty, m_bModifierStatesDirty) == 0x198);
    static_assert(offsetof(CModifierProperty, m_bPredictedOwner) == 0x199);
    static_assert(offsetof(CModifierProperty, m_iLockRefCount) == 0x19a);
