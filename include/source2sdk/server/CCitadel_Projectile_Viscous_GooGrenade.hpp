...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t m_nBounces; // 0x878        
        entity2::GameTime_t m_tNextDetonateTime; // 0x87c        
