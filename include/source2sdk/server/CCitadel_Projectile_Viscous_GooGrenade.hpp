...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_tNextDetonateTime; // 0x86c        
        ...
        char m_vecProjectileHitTargets[0x18]; // 0x870        
        [[maybe_unused]] std::uint8_t pad_0x888[0x28];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Projectile_Viscous_GooGrenade because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Projectile_Viscous_GooGrenade) == 0x8b0);
};
