...
namespace source2sdk::server
{
    ...
    {
    public:
        int32_t m_cTicksNoMovement; // 0x850        
        ...
        char m_DustStormAbility[0x4]; // 0x854        
        [[maybe_unused]] std::uint8_t pad_0x858[0x1c0];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Projectile_DustStorm because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Projectile_DustStorm) == 0xa18);
};
