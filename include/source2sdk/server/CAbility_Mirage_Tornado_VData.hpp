...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_TornadoCastParticle[0xe0]; // 0x1550        
        ...
        char m_WhirlwindEvasionModifier[0x10]; // 0x1640        
        ...
        char m_TornadoAura[0x10]; // 0x1650        
        ...
        char m_GrenadeTrailModifier[0x10]; // 0x1660        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceTravelingInTornado; // 0x1670        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbility_Mirage_Tornado_VData because it is not a standard-layout class
    static_assert(sizeof(CAbility_Mirage_Tornado_VData) == 0x16f8);
};
