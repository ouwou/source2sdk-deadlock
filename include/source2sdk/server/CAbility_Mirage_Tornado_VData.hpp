...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_TornadoCastParticle[0xe0]; // 0x14f0        
        ...
        char m_TornadoAura[0x10]; // 0x15d0        
