...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_vecPushers[0x18]; // 0x970        
        bool m_bUseCenterPusher; // 0x988        
        bool m_bUseForwardPusher; // 0x989        
        [[maybe_unused]] std::uint8_t pad_0x98a[0x6];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CNpcFootSweep because it is not a standard-layout class
    static_assert(sizeof(CNpcFootSweep) == 0x990);
};
