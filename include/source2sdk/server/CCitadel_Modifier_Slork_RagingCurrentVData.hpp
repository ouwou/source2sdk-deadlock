...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_CountdownModifier;
        char m_CountdownModifier[0x10]; // 0x5f8        
