...
namespace source2sdk::server
{
    ...
    public:
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_SilenceProcModifier;
        char m_SilenceProcModifier[0x10]; // 0x638        
        ...
        char m_SilenceActiveModifier[0x10]; // 0x648        
        ...
        char m_TracerParticle[0xe0]; // 0x670        
    };
    #pragma pack(pop)
