...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_LandingParticle[0xe0]; // 0x1678        
        ...
        char m_AoEPreviewParticle[0xe0]; // 0x1758        
        ...
        char m_DropDownStartParticle[0xe0]; // 0x1838        
        ...
        char m_DebuffModifier[0x10]; // 0x1938        
    ...
    static_assert(sizeof(CCitadel_UtilityUpgrade_RocketBoosterVData) == 0x1950);
};
