...
namespace source2sdk::server
{
    ...
    public:
        ...
        CUtlString m_targetCamera; // 0x7e8        
        // metadata: MNetworkEnable
        int32_t m_nResolutionEnum; // 0x7f0        
        // metadata: MNetworkEnable
        bool m_bRenderShadows; // 0x7f4        
        // metadata: MNetworkEnable
        bool m_bUseUniqueColorTarget; // 0x7f5        
        [[maybe_unused]] std::uint8_t pad_0x7f6[0x2]; // 0x7f6
        // metadata: MNetworkEnable
        CUtlString m_brushModelName; // 0x7f8        
        // metadata: MNetworkEnable
        ...
        char m_hTargetCamera[0x4]; // 0x800        
        // metadata: MNetworkEnable
        bool m_bEnabled; // 0x804        
        // metadata: MNetworkEnable
        bool m_bDraw3DSkybox; // 0x805        
        bool m_bStartEnabled; // 0x806        
        [[maybe_unused]] std::uint8_t pad_0x807[0x1];
    ...
    static_assert(sizeof(CFuncMonitor) == 0x808);
};
