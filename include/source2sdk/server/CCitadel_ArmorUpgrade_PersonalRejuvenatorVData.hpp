...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_DeployParticle[0xe0]; // 0x1598        
        ...
        char m_RespawnParticle[0xe0]; // 0x1678        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_sDeploySound; // 0x1758        
        CSoundEventName m_sRespawnSound; // 0x1768        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_ArmorUpgrade_PersonalRejuvenatorVData) == 0x1778);
};
