...
namespace source2sdk::server
{
    ...
    public:
        ...
        CSoundEventName m_ExplosionSound; // 0x1628        
        CSoundEventName m_RocketFireSound; // 0x1638        
    ...
    static_assert(sizeof(CCitadel_Ability_Tier2Boss_RocketBarrageVData) == 0x1658);
};
