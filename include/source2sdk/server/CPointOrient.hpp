...
namespace source2sdk::server
{
    ...
    public:
        ...
        client::PointOrientGoalDirectionType_t m_nGoalDirection; // 0x4f8        
        client::PointOrientConstraint_t m_nConstraint; // 0x4fc        
        float m_flMaxTurnRate; // 0x500        
        entity2::GameTime_t m_flLastGameTime; // 0x504        
    ...
    static_assert(sizeof(CPointOrient) == 0x508);
};
