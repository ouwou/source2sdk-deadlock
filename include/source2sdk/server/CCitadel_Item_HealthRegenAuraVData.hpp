...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_HealParticle[0xe0]; // 0x1538        
        ...
        char m_CastHealParticle[0xe0]; // 0x1618        
