...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hPostSettings[0x8]; // 0x980        
        // metadata: MNetworkEnable
        float m_flFadeDuration; // 0x988        
        // metadata: MNetworkEnable
        float m_flMinLogExposure; // 0x98c        
        // metadata: MNetworkEnable
        float m_flMaxLogExposure; // 0x990        
        // metadata: MNetworkEnable
        float m_flMinExposure; // 0x994        
        // metadata: MNetworkEnable
        float m_flMaxExposure; // 0x998        
        // metadata: MNetworkEnable
        float m_flExposureCompensation; // 0x99c        
        // metadata: MNetworkEnable
        float m_flExposureFadeSpeedUp; // 0x9a0        
        // metadata: MNetworkEnable
        float m_flExposureFadeSpeedDown; // 0x9a4        
        // metadata: MNetworkEnable
        float m_flTonemapEVSmoothingRange; // 0x9a8        
        // metadata: MNetworkEnable
        bool m_bMaster; // 0x9ac        
        // metadata: MNetworkEnable
        bool m_bExposureControl; // 0x9ad        
        [[maybe_unused]] std::uint8_t pad_0x9ae[0x2];
    };
    #pragma pack(pop)
