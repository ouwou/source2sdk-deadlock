...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SuccessModifier[0x10]; // 0x1570        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strSuccessSound; // 0x1580        
        CSoundEventName m_strFailureSound; // 0x1590        
        ...
        char m_SuccessParticle[0xe0]; // 0x15a0        
        ...
        char m_FailureParticle[0xe0]; // 0x1680        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flGraceTime; // 0x1760        
    ...
    static_assert(sizeof(CItem_ActiveReload_VData) == 0x1768);
};
