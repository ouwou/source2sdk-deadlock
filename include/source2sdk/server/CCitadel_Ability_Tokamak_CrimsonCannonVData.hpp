...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ChargeParticle[0xe0]; // 0x1648        
        ...
        char m_CasterOnlyTargetParticle[0xe0]; // 0x1728        
        ...
        char m_EnemyTargetedParticle[0xe0]; // 0x1808        
    ...
    static_assert(sizeof(CCitadel_Ability_Tokamak_CrimsonCannonVData) == 0x1938);
};
