...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_PredatoryStatueModel[0xe0]; // 0x1550        
        ...
        char m_CatReappearParticle[0xe0]; // 0x1630        
        ...
        char m_CatDisappearParticle[0xe0]; // 0x1710        
        ...
        char m_CatEyesParticle[0xe0]; // 0x17f0        
        ...
        char m_CatSummonParticle[0xe0]; // 0x18d0        
        ...
        char m_CatRecallParticle[0xe0]; // 0x19b0        
        ...
        char m_RecallLineParticle[0xe0]; // 0x1a90        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strRecallSound; // 0x1b70        
        CSoundEventName m_strKilledSound; // 0x1b80        
        ...
        char m_PredatoryStatueModifier[0x10]; // 0x1b90        
        ...
        char m_RecentDamageModifier[0x10]; // 0x1ba0        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flHeavyMeleeDmg; // 0x1bb0        
        float m_flLightMeleeDmg; // 0x1bb4        
        float m_flAbilityDamageScale; // 0x1bb8        
        float m_flNPCDamageScale; // 0x1bbc        
        float m_flCastDelayMin; // 0x1bc0        
        float m_flCastDelayMax; // 0x1bc4        
        float m_flCastDelayMaxDist; // 0x1bc8        
        float m_flPostCastCooldown; // 0x1bcc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ProximityRitual_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_ProximityRitual_VData) == 0x1bd0);
};
