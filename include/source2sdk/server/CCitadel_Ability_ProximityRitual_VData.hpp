...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_UnitTargetParticle[0xe0]; // 0x1528        
        ...
        char m_PredatoryStatueModel[0xe0]; // 0x1608        
        ...
        char m_CatReappearParticle[0xe0]; // 0x16e8        
        ...
        char m_CatDisappearParticle[0xe0]; // 0x17c8        
        ...
        char m_CatEyesParticle[0xe0]; // 0x18a8        
        ...
        char m_CatSummonParticle[0xe0]; // 0x1988        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strRecallSound; // 0x1a68        
        CSoundEventName m_strKilledSound; // 0x1a78        
        ...
        char m_PredatoryStatueModifier[0x10]; // 0x1a88        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flHeavyMeleeDmg; // 0x1a98        
        float m_flLightMeleeDmg; // 0x1a9c        
        float m_flAbilityDamageScale; // 0x1aa0        
        float m_flNPCDamageMax; // 0x1aa4        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_ProximityRitual_VData because it is not a standard-layout class
    
    static_assert(sizeof(CCitadel_Ability_ProximityRitual_VData) == 0x1aa8);
};
