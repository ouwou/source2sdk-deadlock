...
namespace source2sdk::server
{
    ...
    {
    public:
        server::CPathTrack* m_trackTop; // 0x890        
        server::CPathTrack* m_trackBottom; // 0x898        
        server::CFuncTrackTrain* m_train; // 0x8a0        
        CUtlSymbolLarge m_trackTopName; // 0x8a8        
        CUtlSymbolLarge m_trackBottomName; // 0x8b0        
        CUtlSymbolLarge m_trainName; // 0x8b8        
        server::TRAIN_CODE m_code; // 0x8c0        
        int32_t m_targetState; // 0x8c4        
        int32_t m_use; // 0x8c8        
    ...
    static_assert(sizeof(CFuncTrackChange) == 0x8d0);
};
