...
namespace source2sdk::server
{
    ...
    {
    public:
        server::CPathTrack* m_trackTop; // 0x880        
        server::CPathTrack* m_trackBottom; // 0x888        
        server::CFuncTrackTrain* m_train; // 0x890        
        CUtlSymbolLarge m_trackTopName; // 0x898        
        CUtlSymbolLarge m_trackBottomName; // 0x8a0        
        CUtlSymbolLarge m_trainName; // 0x8a8        
        server::TRAIN_CODE m_code; // 0x8b0        
    ...
    static_assert(sizeof(CFuncTrackChange) == 0x8c0);
};
