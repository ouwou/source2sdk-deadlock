...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_DashModifier[0x10]; // 0x1568        
        ...
        char m_DashImpactEffect[0xe0]; // 0x1578        
        ...
        char m_DashSwingEffect[0xe0]; // 0x1658        
        ...
        char m_DashLineEffect[0xe0]; // 0x1738        
    ...
    static_assert(sizeof(CAbilityShivDashVData) == 0x1860);
};
