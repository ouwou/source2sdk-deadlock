...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hSpriteMaterial[0x8]; // 0x7a0        
        // metadata: MNetworkEnable
        ...
        char m_hAttachedToEntity[0x4]; // 0x7a8        
        // metadata: MNetworkEnable
        modellib::AttachmentHandle_t m_nAttachment; // 0x7ac        
        ...
        float m_flSpriteFramerate; // 0x7b0        
        // metadata: MNetworkEnable
        // metadata: MNetworkBitCount "20"
        // metadata: MNetworkMinValue "0.000000"
        // metadata: MNetworkMaxValue "256.000000"
        // metadata: MNetworkEncodeFlags "1"
        float m_flFrame; // 0x7b4        
        entity2::GameTime_t m_flDieTime; // 0x7b8        
        [[maybe_unused]] std::uint8_t pad_0x7bc[0xc]; // 0x7bc
        // metadata: MNetworkEnable
        uint32_t m_nBrightness; // 0x7c8        
        // metadata: MNetworkEnable
        float m_flBrightnessDuration; // 0x7cc        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnSpriteScaleChanged"
        float m_flSpriteScale; // 0x7d0        
        // metadata: MNetworkEnable
        float m_flScaleDuration; // 0x7d4        
        // metadata: MNetworkEnable
        bool m_bWorldSpaceScale; // 0x7d8        
        ...
        // metadata: MNetworkEncodeFlags "2"
        float m_flGlowProxySize; // 0x7dc        
        // metadata: MNetworkEnable
        float m_flHDRColorScale; // 0x7e0        
        entity2::GameTime_t m_flLastTime; // 0x7e4        
        float m_flMaxFrame; // 0x7e8        
        float m_flStartScale; // 0x7ec        
        float m_flDestScale; // 0x7f0        
        entity2::GameTime_t m_flScaleTimeStart; // 0x7f4        
        int32_t m_nStartBrightness; // 0x7f8        
        int32_t m_nDestBrightness; // 0x7fc        
        entity2::GameTime_t m_flBrightnessTimeStart; // 0x800        
        int32_t m_nSpriteWidth; // 0x804        
        int32_t m_nSpriteHeight; // 0x808        
    ...
    static_assert(sizeof(CSprite) == 0x810);
};
