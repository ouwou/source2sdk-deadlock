...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_strAreaEffectEnemy[0xe0]; // 0x650        
        ...
        char m_strAreaEffectFriendly[0xe0]; // 0x730        
