...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_RadianceFxParticle[0xe0]; // 0x630        
        ...
        char m_RadianceDamageParticle[0xe0]; // 0x710        
        ...
        char m_ClientsideDamageParticle[0xe0]; // 0x7f0        
    ...
    static_assert(sizeof(CCitadel_Modifier_RadianceVData) == 0x8e0);
};
