...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flLastPickupCheck; // 0xb2c        
        ...
        char m_hSpawnParticleEffect[0x8]; // 0xb38        
        ...
        char m_hPickupParticleEffect[0x8]; // 0xb58        
        ...
        char m_hTimeoutParticleEffect[0x8]; // 0xb70        
        ...
        char m_hPickupFilter[0x4]; // 0xb90        
        [[maybe_unused]] std::uint8_t pad_0xb94[0x4]; // 0xb94
        entity2::CEntityIOOutput m_OnPickup; // 0xb98        
        entity2::CEntityIOOutput m_OnTimeout; // 0xbc0        
        entity2::CEntityIOOutput m_OnTriggerStartTouch; // 0xbe8        
        entity2::CEntityIOOutput m_OnTriggerTouch; // 0xc10        
        entity2::CEntityIOOutput m_OnTriggerEndTouch; // 0xc38        
        ...
        char m_hTriggerHelper[0x4]; // 0xc80        
    ...
    static_assert(sizeof(CItemGeneric) == 0xc88);
};
