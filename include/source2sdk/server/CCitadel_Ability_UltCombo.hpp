...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hTargetComboModifier[0x18]; // 0xaf0        
        entity2::GameTime_t m_flLastAttackTime; // 0xb08        
        int32_t m_nAttackNum; // 0xb0c        
        [[maybe_unused]] std::uint8_t pad_0xb10[0xa8]; // 0xb10
        // metadata: MNetworkEnable
        int32_t m_iBonusHealth; // 0xbb8        
        // metadata: MNetworkEnable
        // m_hTarget has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CHandle<server::CBaseEntity> m_hTarget;
        char m_hTarget[0x4]; // 0xbbc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_UltCombo because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_UltCombo) == 0xbc0);
};
