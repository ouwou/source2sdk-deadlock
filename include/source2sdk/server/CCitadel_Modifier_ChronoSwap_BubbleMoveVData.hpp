...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BeamParticle[0xe0]; // 0x630        
        ...
        char m_HealParticle[0xe0]; // 0x710        
        ...
        char m_DamageParticle[0xe0]; // 0x7f0        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Modifier_ChronoSwap_BubbleMoveVData) == 0x8d0);
};
