...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1800[0x63]; // 0x1800
        // metadata: MNetworkEnable
        bool m_bShieldActive; // 0x1863        
        // metadata: MNetworkEnable
        bool m_bPlayingIdle; // 0x1864        
        [[maybe_unused]] std::uint8_t pad_0x1865[0x3];
    ...
    static_assert(sizeof(CNPC_TrooperNeutral) == 0x1868);
};
