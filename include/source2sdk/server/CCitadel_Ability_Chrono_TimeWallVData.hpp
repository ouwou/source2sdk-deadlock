...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_TimeWallParticle[0xe0]; // 0x1578        
        ...
        char m_TimeWallChargeParticle[0xe0]; // 0x1658        
        ...
        char m_TimeWallHitParticle[0xe0]; // 0x1738        
        ...
        char m_TimeWallHitTimerParticle[0xe0]; // 0x1818        
    ...
    static_assert(sizeof(CCitadel_Ability_Chrono_TimeWallVData) == 0x1918);
};
