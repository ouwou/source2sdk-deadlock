...
namespace source2sdk::server
{
    ...
    {
    public:
        CPiecewiseCurve m_CrashSpeedScaleCurve; // 0x1550        
        ...
        char m_BoostModifier[0x10]; // 0x1590        
        ...
        char m_CrashModifier[0x10]; // 0x15a0        
        ...
        char m_ImmunityModifier[0x10]; // 0x15b0        
        ...
        char m_LandingBonusesModifier[0x10]; // 0x15c0        
        ...
        char m_TakeOffParticle[0xe0]; // 0x15d0        
        // m_ImpactParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ImpactParticle;
        char m_ImpactParticle[0xe0]; // 0x16b0        
        ...
        char m_AoEPreviewParticle[0xe0]; // 0x1790        
        ...
        char m_nHoverParticle[0xe0]; // 0x1870        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strCrashingSound; // 0x1950        
        CSoundEventName m_strImpactSound; // 0x1960        
        // metadata: MPropertyStartGroup "GamePlay"
        float m_flStartupTime; // 0x1970        
        float m_flForwardBoostSpeed; // 0x1974        
        float m_flUpBoostSpeed; // 0x1978        
        float m_flBoostTurnRate; // 0x197c        
        float m_flHoverTime; // 0x1980        
        float m_flMinAimAngle; // 0x1984        
        float m_flBoostGain; // 0x1988        
        float m_flBoostTime; // 0x198c        
        float m_flLandingTime; // 0x1990        
        float m_flCrashSpeed; // 0x1994        
        float m_flHoverInputSpeedMax; // 0x1998        
        float m_flHoverInputAcceleration; // 0x199c        
        float m_flHoverSpeedDecay; // 0x19a0        
    ...
    static_assert(sizeof(CCitadel_Ability_Bull_LeapVData) == 0x19a8);
};
