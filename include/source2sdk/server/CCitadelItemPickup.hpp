...
namespace source2sdk::server
{
    ...
    public:
        ...
        server::CCitadelMinimapComponent m_CCitadelMinimapComponent; // 0xbb0        
        // metadata: MNetworkEnable
        int32_t m_eLootType; // 0xbc8        
        // metadata: MNetworkEnable
        int32_t m_nCurrencyValue; // 0xbcc        
        // metadata: MNetworkEnable
        CUtlSymbolLarge m_iszModelName; // 0xbd0        
        // metadata: MNetworkEnable
        float m_flModelScale; // 0xbd8        
        // metadata: MNetworkEnable
        ...
        char m_hTargetPlayer[0x4]; // 0xbdc        
        // metadata: MNetworkEnable
        float m_flFallRate; // 0xbe0        
        [[maybe_unused]] std::uint8_t pad_0xbe4[0xc]; // 0xbe4
        Vector m_vHomePosition; // 0xbf0        
        Vector m_vDropPosition; // 0xbfc        
        entity2::GameTime_t m_tFirstPickupTime; // 0xc08        
        [[maybe_unused]] std::uint8_t pad_0xc0c[0x58a4];
        
        // Datamap fields:
        // bool m_bRequireGroundForPickup; // 0xbe8
        // bool from_crate; // 0x7fffffff
        // int32_t m_eObjectivePosition; // 0xbe4
        // int32_t m_nKillingTeamNumber; // 0xbec
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadelItemPickup because it is not a standard-layout class
    static_assert(sizeof(CCitadelItemPickup) == 0x64b0);
};
