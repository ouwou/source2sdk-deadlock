...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ExplodeBaseParticle[0xe0]; // 0x1528        
        ...
        char m_ExplodeFriendlyParticle[0xe0]; // 0x1608        
        ...
        char m_ExplodeEnemyParticle[0xe0]; // 0x16e8        
        ...
        char m_ModifierDragEnemy[0x10]; // 0x17d8        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flOnHitDetonateTimer; // 0x17e8        
        float m_flTraceTravelRadius; // 0x17ec        
    };
    #pragma pack(pop)
