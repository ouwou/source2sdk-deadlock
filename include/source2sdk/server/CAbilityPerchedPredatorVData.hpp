...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ExplodeBaseParticle[0xe0]; // 0x1560        
        ...
        char m_ExplodeFriendlyParticle[0xe0]; // 0x1640        
        ...
        char m_ExplodeEnemyParticle[0xe0]; // 0x1720        
        ...
        char m_ModifierDragEnemy[0x10]; // 0x1810        
    ...
    static_assert(sizeof(CAbilityPerchedPredatorVData) == 0x1828);
};
