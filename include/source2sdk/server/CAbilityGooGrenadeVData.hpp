...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_GooGrenadeImpactModifier[0x10]; // 0x1528        
        ...
        char m_GooGrenadePuddleAuraModifier[0x10]; // 0x1538        
        ...
        char m_GooGrenadeSkipParticle[0xe0]; // 0x1548        
        ...
        char m_GooGrenadeExplodeParticle[0xe0]; // 0x1628        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_GrenadeHitImpactSound; // 0x1708        
        CSoundEventName m_GrenadeMissImpactSound; // 0x1718        
        // metadata: MPropertyStartGroup "BounceSettings"
        float m_flMinRestitution; // 0x1728        
        float m_flMaxRestitution; // 0x172c        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityGooGrenadeVData because it is not a standard-layout class
    static_assert(sizeof(CAbilityGooGrenadeVData) == 0x1730);
};
