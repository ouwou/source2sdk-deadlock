...
namespace source2sdk::server
{
    ...
    public:
        ...
        modellib::AttachmentHandle_t m_hLerpTargetAttachment; // 0x9b0        
        ...
        [[maybe_unused]] std::uint8_t pad_0x9ba[0x6]; // 0x9ba
        ...
        entity2::CEntityIOOutput m_OnLerpStarted; // 0x9f0        
        entity2::CEntityIOOutput m_OnLerpFinished; // 0xa18        
    ...
    static_assert(sizeof(CTriggerLerpObject) == 0xa40);
};
