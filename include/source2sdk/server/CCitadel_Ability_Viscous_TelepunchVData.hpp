...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_PortalParticle[0xe0]; // 0x1550        
        // m_CastParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_CastParticle;
        char m_CastParticle[0xe0]; // 0x1630        
        ...
        char m_PunchParticle[0xe0]; // 0x1710        
        ...
        char m_WallPunchParticle[0xe0]; // 0x17f0        
        ...
        char m_CeilingPunchParticle[0xe0]; // 0x18d0        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_EnemyPortalSound; // 0x19b0        
        CSoundEventName m_SelfPortalSound; // 0x19c0        
        CSoundEventName m_WindupSound; // 0x19d0        
        CSoundEventName m_PunchSound; // 0x19e0        
        ...
        char m_PunchRollSlowModifier[0x10]; // 0x19f0        
        ...
        char m_ImpactModifier[0x10]; // 0x1a00        
        // metadata: MPropertyStartGroup "+Telepunch Parameters"
        float m_flEnemyPortalTelegraphTime; // 0x1a10        
        float m_flSelfPortalTelegraphTime; // 0x1a14        
        float m_flWindupTime; // 0x1a18        
        float m_flAttackTime; // 0x1a1c        
        float m_flGroundTraceOnPlayerHitDistance; // 0x1a20        
        float m_flPlayerCheckSphereRadius; // 0x1a24        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Viscous_TelepunchVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Viscous_TelepunchVData) == 0x1a28);
};
