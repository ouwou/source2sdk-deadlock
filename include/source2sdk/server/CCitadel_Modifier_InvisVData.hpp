...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_InvisLoopParticle[0xe0]; // 0x5f8        
        ...
        char m_InvisDetectRadiusParticle[0xe0]; // 0x6d8        
        ...
        char m_InvisRevealedParticle[0xe0]; // 0x7b8        
    ...
    static_assert(sizeof(CCitadel_Modifier_InvisVData) == 0x8b0);
};
