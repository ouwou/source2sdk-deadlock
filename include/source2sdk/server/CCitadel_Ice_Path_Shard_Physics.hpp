...
namespace source2sdk::server
{
    ...
    public:
        ...
        server::ice_path_shard_model_desc_t m_ShardDesc; // 0x7c0        
        // metadata: MNetworkEnable
        QAngle m_qForward; // 0x7f8        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnStartTimeChanged"
        entity2::GameTime_t m_flStartTime; // 0x804        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnEndTimeChanged"
        entity2::GameTime_t m_flEndTime; // 0x808        
        ...
        char m_hTrooperTrigger[0x4]; // 0x810        
    ...
    static_assert(sizeof(CCitadel_Ice_Path_Shard_Physics) == 0x818);
};
