...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0xbd8[0x20]; // 0xbd8
        // m_vecHitEntities has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CUtlVector<CHandle<server::CBaseEntity>> m_vecHitEntities;
        char m_vecHitEntities[0x18]; // 0xbf8        
        client::ParticleIndex_t m_PreviewEffect; // 0xc10        
        [[maybe_unused]] std::uint8_t pad_0xc14[0x1c4]; // 0xc14
    ...
    static_assert(sizeof(CCitadel_Ability_LashDownStrike) == 0xde8);
};
