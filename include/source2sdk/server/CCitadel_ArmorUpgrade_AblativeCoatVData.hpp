...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_RestoreEffectModifier[0x10]; // 0x15b0        
        ...
        char m_OnTakeDamageEffectModifier[0x10]; // 0x15c0        
        ...
        char m_OnBreakEffectModifier[0x10]; // 0x15d0        
        ...
        char m_ResistBuffModifier[0x10]; // 0x15e0        
    ...
    static_assert(sizeof(CCitadel_ArmorUpgrade_AblativeCoatVData) == 0x1600);
};
