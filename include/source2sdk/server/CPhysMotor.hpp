...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_lastTime; // 0x500        
        [[maybe_unused]] std::uint8_t pad_0x504[0x14]; // 0x504
        server::CMotorController m_motor; // 0x518        
    ...
    static_assert(sizeof(CPhysMotor) == 0x538);
};
