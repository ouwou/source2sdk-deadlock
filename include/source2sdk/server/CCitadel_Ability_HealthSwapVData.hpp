...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SwapParticle[0xe0]; // 0x1528        
        ...
        char m_SwapModifier[0x10]; // 0x1608        
        ...
        char m_PreCastModifier[0x10]; // 0x1618        
    ...
    static_assert(sizeof(CCitadel_Ability_HealthSwapVData) == 0x1638);
};
