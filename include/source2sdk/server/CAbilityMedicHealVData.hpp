...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_HealBeamParticle[0xe0]; // 0x1528        
        ...
        char m_HealTargetParticle[0xe0]; // 0x1608        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strHealCastSound; // 0x16e8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbilityMedicHealVData because it is not a standard-layout class
    
    static_assert(sizeof(CAbilityMedicHealVData) == 0x16f8);
};
