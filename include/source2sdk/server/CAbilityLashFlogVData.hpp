...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_FlogParticle[0xe0]; // 0x14f0        
        // metadata: MPropertyGroupName "Visuals"
        ...
        char m_FlogLifeLeachParticle[0xe0]; // 0x15d0        
