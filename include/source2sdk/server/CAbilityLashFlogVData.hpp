...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_FlogParticle[0xe0]; // 0x1550        
        // metadata: MPropertyGroupName "Visuals"
        ...
        char m_FlogLifeLeachParticle[0xe0]; // 0x1630        
