...
namespace source2sdk::server
{
    ...
    {
    public:
        bool m_bBreakable; // 0x1000        
        bool m_isAbleToCloseAreaPortals; // 0x1001        
        [[maybe_unused]] std::uint8_t pad_0x1002[0x2]; // 0x1002
        int32_t m_currentDamageState; // 0x1004        
        ...
        char m_damageStates[0x18]; // 0x1008        
    ...
    static_assert(sizeof(CPropDoorRotatingBreakable) == 0x1020);
};
