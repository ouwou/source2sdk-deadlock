...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_VictimPushModifier[0x10]; // 0x1560        
        // m_SlowModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<server::CBaseModifier> m_SlowModifier;
        char m_SlowModifier[0x10]; // 0x1570        
        // metadata: MPropertyGroupName "Sounds"
        CSoundEventName m_strDomeCreated; // 0x1580        
        CSoundEventName m_strChargeUpSound; // 0x1590        
        CSoundEventName m_strPushAndDamage; // 0x15a0        
