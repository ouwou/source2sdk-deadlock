...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_DashParticle[0xe0]; // 0x630        
        ...
        char m_DashEchoParticle[0xe0]; // 0x710        
