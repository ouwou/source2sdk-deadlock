...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AOEParticleCaster[0xe0]; // 0x6d8        
        ...
        char m_AOEParticleEnemy[0xe0]; // 0x7b8        
        ...
        char m_AOEParticleOthers[0xe0]; // 0x898        
        ...
        char m_RootModifier[0x10]; // 0x9a8        
