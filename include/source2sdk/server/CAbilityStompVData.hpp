...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_StompParticle[0xe0]; // 0x1528        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strStompExplosionSound; // 0x1608        
        CSoundEventName m_strCastDelayLocalPlayerSound; // 0x1618        
