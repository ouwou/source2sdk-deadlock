...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x4e8[0xd8]; // 0x4e8
        ...
        char m_vecIntrinsicModifiers[0x18]; // 0x5c0        
        ...
        char m_pCastDelayAutoModifier[0x18]; // 0x5d8        
        ...
        char m_pChannelAutoModifier[0x18]; // 0x5f0        
        ...
        entity2::GameTime_t m_flCancelLockoutTime; // 0x618        
        [[maybe_unused]] std::uint8_t pad_0x61c[0x1c]; // 0x61c
        ...
        char m_vecImbuedByAbilitiyIDs[0x18]; // 0x640        
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        entity2::GameTime_t m_flCooldownStart; // 0x664        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        entity2::GameTime_t m_flCooldownEnd; // 0x668        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flCastCompletedTime; // 0x66c        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flChannelStartTime; // 0x670        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flCastDelayStartTime; // 0x674        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnAbilitySlotChanged"
        client::EAbilitySlots_t m_eAbilitySlot; // 0x678        
        [[maybe_unused]] std::uint8_t pad_0x67a[0x2]; // 0x67a
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        entity2::GameTime_t m_flPostCastDelayEndTime; // 0x67c        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        int32_t m_iRemainingCharges; // 0x680        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        entity2::GameTime_t m_flChargeRechargeStart; // 0x684        
        // metadata: MNetworkEnable
        // metadata: MNetworkPriority "32"
        entity2::GameTime_t m_flChargeRechargeEnd; // 0x688        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flMovementControlActiveTime; // 0x68c        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        entity2::GameTime_t m_flSelectedChangedTime; // 0x690        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        entity2::GameTime_t m_flAltCastHoldStartTime; // 0x694        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        entity2::GameTime_t m_flAltCastDoubleTapStartTime; // 0x698        
        // metadata: MNetworkEnable
        CUtlStringToken m_nImbuedAbilityID; // 0x69c        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerAndObserversExclusive"
        bool m_bSelectionModeIsAltMode; // 0x6a0        
        [[maybe_unused]] std::uint8_t pad_0x6a1[0x7]; // 0x6a1
        ...
        char m_vecEnemyHeroesDamaged[0x18]; // 0x6a8        
        float m_flPreviousEffectiveCooldown; // 0x6c0        
        [[maybe_unused]] std::uint8_t pad_0x6c4[0x43c];
