...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BarrageModifier[0x10]; // 0x1568        
        ...
        char m_MoveSlowModifier[0x10]; // 0x1578        
        // metadata: MPropertyStartGroup "Visuals"
        // m_ImpactParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CResourceNameTyped<CWeakHandle<resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ImpactParticle;
        char m_ImpactParticle[0xe0]; // 0x1588        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strExplodeSound; // 0x1668        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceSelected; // 0x1678        
    ...
    static_assert(sizeof(CCitadel_Ability_RocketBarrageVData) == 0x1708);
};
