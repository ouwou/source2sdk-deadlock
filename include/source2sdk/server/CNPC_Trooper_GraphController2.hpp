...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_flForwardSpeed[0x18]; // 0xc8        
        ...
        char m_flLookHeading[0x18]; // 0xf8        
        ...
        char m_flStrafeSpeed[0x18]; // 0x140        
        ...
        char m_flHitLayerTrigger[0x18]; // 0x170        
        ...
        char m_flNumHitReactLayers[0x18]; // 0x188        
        ...
        char m_flRandomMelee[0x18]; // 0x1a0        
        ...
        char m_Locomotion_Facing[0x18]; // 0x1b8        
        ...
        char m_TROOPER_MovementState[0x18]; // 0x278        
    ...
    static_assert(sizeof(CNPC_Trooper_GraphController2) == 0x290);
};
