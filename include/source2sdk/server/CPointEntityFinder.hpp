...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hReference[0x4]; // 0x508        
        server::EntFinderMethod_t m_FindMethod; // 0x50c        
        entity2::CEntityIOOutput m_OnFoundEntity; // 0x510        
    ...
    static_assert(sizeof(CPointEntityFinder) == 0x538);
};
