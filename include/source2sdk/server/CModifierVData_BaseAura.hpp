...
namespace source2sdk::server
{
    ...
    {
    public:
        client::eAuraShapeType m_eAuraShapeType; // 0x630        
        // metadata: MPropertySuppressExpr "m_eAuraShapeType != k_eAuraShapeTypeSphere"
        client::CModifierLevelFloat m_flAuraRadius; // 0x634        
        // metadata: MPropertySuppressExpr "m_eAuraShapeType != k_eAuraShapeTypeEntityBased"
        client::CModifierLevelFloat m_flAuraEntityBoundsScale; // 0x644        
