...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SummonParticle[0xe0]; // 0x1598        
        ...
        char m_FlyingCarpetModifier[0x10]; // 0x1678        
        ...
        char m_SummonFlyingCarpetModifier[0x10]; // 0x1688        
        ...
        char m_SummonFlyingCarpetVisualModifier[0x10]; // 0x1698        
        ...
        char m_FlyingCarpetVisualModifier[0x10]; // 0x16a8        
        ...
        char m_ShieldModifier[0x10]; // 0x16b8        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flSummonVisualDuration; // 0x16c8        
        float m_flBurstSpeedBonus; // 0x16cc        
        float m_flBurstSpeedMin; // 0x16d0        
        float m_flBurstSpeedDuration; // 0x16d4        
        float m_flMinDistanceAboveGround; // 0x16d8        
    ...
    static_assert(sizeof(CCitadel_Upgrade_MagicCarpetVData) == 0x16e0);
};
