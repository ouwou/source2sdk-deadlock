...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_SummonParticle[0xe0]; // 0x15a8        
        ...
        char m_FlyingCarpetModifier[0x10]; // 0x1688        
        ...
        char m_SummonFlyingCarpetModifier[0x10]; // 0x1698        
        ...
        char m_SummonFlyingCarpetVisualModifier[0x10]; // 0x16a8        
        ...
        char m_FlyingCarpetVisualModifier[0x10]; // 0x16b8        
        ...
        char m_ShieldModifier[0x10]; // 0x16c8        
    ...
    static_assert(sizeof(CCitadel_Upgrade_MagicCarpetVData) == 0x16f0);
};
