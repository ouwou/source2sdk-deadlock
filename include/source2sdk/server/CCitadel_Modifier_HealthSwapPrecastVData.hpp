...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_strTargetParticleEffect[0xe0]; // 0x630        
        ...
        char m_strTargetEnemyParticleEffect[0xe0]; // 0x710        
