...
namespace source2sdk::server
{
    ...
    public:
        ...
        CSoundEventName m_HeadShotVictimSound; // 0x1590        
        CSoundEventName m_HeadShotConfirmationSound; // 0x15a0        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_WeaponUpgrade_HeadshotBooster_VData) == 0x15b0);
};
