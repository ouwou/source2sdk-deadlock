...
namespace source2sdk::server
{
    ...
    public:
        ...
        [[maybe_unused]] std::uint8_t pad_0x15d4[0x30]; // 0x15d4
        // metadata: MNetworkEnable
        ...
        [[maybe_unused]] std::uint8_t pad_0x1620[0x20]; // 0x1620
        ...
        [[maybe_unused]] std::uint8_t pad_0x1678[0x4]; // 0x1678
        // metadata: MNetworkEnable
        client::ETier3Phase_t m_ePhase; // 0x167c        
        [[maybe_unused]] std::uint8_t pad_0x1680[0x8];
    ...
    static_assert(sizeof(CNPC_Boss_Tier3) == 0x1688);
};
