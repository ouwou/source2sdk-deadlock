...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_iLane; // 0x1800        
        [[maybe_unused]] std::uint8_t pad_0x1804[0x30]; // 0x1804
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "qangle"
        QAngle m_angTargeting1; // 0x1834        
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "qangle"
        QAngle m_angTargeting2; // 0x1840        
        // metadata: MNetworkEnable
        int32_t m_nElectricBeamCasts; // 0x184c        
        [[maybe_unused]] std::uint8_t pad_0x1850[0x20]; // 0x1850
        entity2::CEntityIOOutput m_eventOnBossKilled; // 0x1870        
        CUtlSymbolLarge m_backdoorProtectionTrigger; // 0x1898        
        [[maybe_unused]] std::uint8_t pad_0x18a0[0x4]; // 0x18a0
        // metadata: MNetworkEnable
        client::ETier3State_t m_eAliveState; // 0x18a4        
        [[maybe_unused]] std::uint8_t pad_0x18a8[0x4]; // 0x18a8
        // metadata: MNetworkEnable
        client::ETier3Phase_t m_ePhase; // 0x18ac        
        [[maybe_unused]] std::uint8_t pad_0x18b0[0x8];
        ...
        // Datamap fields:
        // void m_vecStartingPosition; // 0x1810
        // int32_t m_nDyingEndCoverPointID; // 0x1820
        // int32_t m_nVulnerableCoverPointID; // 0x1824
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CNPC_Boss_Tier3 because it is not a standard-layout class
    static_assert(sizeof(CNPC_Boss_Tier3) == 0x18b8);
};
