...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xe0[0xe0]; // 0xe0
        ...
        char m_vecTimeWarps[0x18]; // 0x1c0        
        [[maybe_unused]] std::uint8_t pad_0x1d8[0x18];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_TimeWall_Aura because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_TimeWall_Aura) == 0x1f0);
};
