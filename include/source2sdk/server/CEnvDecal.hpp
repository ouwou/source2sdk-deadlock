...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_hDecalMaterial[0x8]; // 0x7a0        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnDecalDimensionsChanged"
        float m_flWidth; // 0x7a8        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnDecalDimensionsChanged"
        float m_flHeight; // 0x7ac        
        // metadata: MNetworkEnable
        // metadata: MNetworkChangeCallback "OnDecalDimensionsChanged"
        float m_flDepth; // 0x7b0        
        // metadata: MNetworkEnable
        uint32_t m_nRenderOrder; // 0x7b4        
        // metadata: MNetworkEnable
        bool m_bProjectOnWorld; // 0x7b8        
        // metadata: MNetworkEnable
        bool m_bProjectOnCharacters; // 0x7b9        
        // metadata: MNetworkEnable
        bool m_bProjectOnWater; // 0x7ba        
        [[maybe_unused]] std::uint8_t pad_0x7bb[0x1]; // 0x7bb
        // metadata: MNetworkEnable
        float m_flDepthSortBias; // 0x7bc        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CEnvDecal because it is not a standard-layout class
    static_assert(sizeof(CEnvDecal) == 0x7c0);
};
