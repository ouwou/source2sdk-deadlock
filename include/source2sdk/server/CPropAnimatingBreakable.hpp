...
namespace source2sdk::server
{
    ...
    {
    public:
        client::CBreakableStageHelper m_stages; // 0xa28        
        entity2::CEntityIOOutput m_OnTakeDamage; // 0xa40        
        entity2::CEntityIOOutput m_OnFinalBreak; // 0xa68        
        entity2::CEntityIOOutput m_OnStageAdvanced; // 0xa90        
    ...
    static_assert(sizeof(CPropAnimatingBreakable) == 0xab8);
};
