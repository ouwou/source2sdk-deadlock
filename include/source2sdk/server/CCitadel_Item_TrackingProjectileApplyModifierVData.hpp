...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x15b0        
        ...
        char m_TargetModifier[0x10]; // 0x1690        
        ...
        char m_FriendlyOnlyModifier[0x10]; // 0x16a0        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x16b0);
};
