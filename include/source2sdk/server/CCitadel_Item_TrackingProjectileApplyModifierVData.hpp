...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ProjectileImpactParticle[0xe0]; // 0x1538        
        ...
        char m_FriendlyOnlyModifier[0x10]; // 0x1628        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x1638);
};
