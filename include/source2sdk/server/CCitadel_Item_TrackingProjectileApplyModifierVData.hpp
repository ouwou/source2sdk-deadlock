...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_TargetModifier[0x10]; // 0x1678        
        ...
        char m_FriendlyOnlyModifier[0x10]; // 0x1688        
    };
    #pragma pack(pop)
    ...
    static_assert(sizeof(CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x1698);
};
