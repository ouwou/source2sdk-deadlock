...
namespace source2sdk::server
{
    ...
    public:
        ...
        float m_flJumpFallSpeedMax; // 0x1558        
        float m_flJumpAirDrag; // 0x155c        
        float m_flJumpAirSpeedMax; // 0x1560        
        ...
        float m_flOnCancelVerticalSpeedBonus; // 0x1564        
        float m_flFlyingCloseEnoughToTarget; // 0x1568        
        [[maybe_unused]] std::uint8_t pad_0x156c[0x4]; // 0x156c
        CPiecewiseCurve m_curveSpeedScale; // 0x1570        
        // metadata: MPropertyStartGroup "+Attack Properties"
        float m_flAnimToStrikePointTime; // 0x15b0        
        float m_flAnimToStrikeArrivalBias; // 0x15b4        
        // metadata: MPropertyStartGroup "+Grapple Properties"
        float m_flGrappleShotFloatTime; // 0x15b8        
        float m_flGrappleShotDelayToFlyOnHit; // 0x15bc        
        float m_flGrappleSpeed; // 0x15c0        
        ...
        char m_WeaponBuffModifier[0x10]; // 0x15e8        
        ...
        char m_LeapParticle[0xe0]; // 0x15f8        
        ...
        char m_SlashParticle[0xe0]; // 0x17b8        
        ...
        char m_BulletGrappleTracerParticle[0xe0]; // 0x1898        
        ...
        char m_EnemyGrappleParticle[0xe0]; // 0x1978        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strDamageTarget; // 0x1a58        
        CSoundEventName m_strStartFlyingToTarget; // 0x1a68        
        CSoundEventName m_strStartAttack; // 0x1a78        
        CSoundEventName m_strGrappleHitTarget; // 0x1a88        
        CSoundEventName m_strGrappleHitWorld; // 0x1a98        
        CSoundEventName m_strGrappleHitNothing; // 0x1aa8        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceFlying; // 0x1ab8        
        client::CitadelCameraOperationsSequence_t m_cameraSequenceAttacking; // 0x1b40        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadelAbilityFlyingStrikeVData because it is not a standard-layout class
    static_assert(sizeof(CCitadelAbilityFlyingStrikeVData) == 0x1bc8);
};
