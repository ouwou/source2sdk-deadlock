...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_AmbushModifier[0x10]; // 0x8c0        
        ...
        // CEmbeddedSubclass<server::CCitadelModifier> m_VisibleModifier;
        char m_VisibleModifier[0x10]; // 0x8d0        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Modifier_Slork_Invis_VData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Modifier_Slork_Invis_VData) == 0x8e0);
};
