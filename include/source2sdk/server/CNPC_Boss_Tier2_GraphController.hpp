...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_pszStompAttack[0x28]; // 0xbb8        
        ...
        char m_pszStaggerDirection[0x28]; // 0xbe0        
        ...
        char m_pszElectricBeamPosition[0x28]; // 0xc08        
    ...
    static_assert(sizeof(CNPC_Boss_Tier2_GraphController) == 0xc80);
};
