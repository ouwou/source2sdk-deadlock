...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_pszStompAttack[0x28]; // 0x5e8        
        ...
        char m_pszStaggerDirection[0x28]; // 0x610        
        ...
        char m_pszElectricBeamPosition[0x28]; // 0x638        
    ...
    static_assert(sizeof(CNPC_Boss_Tier2_GraphController) == 0x6b0);
};
