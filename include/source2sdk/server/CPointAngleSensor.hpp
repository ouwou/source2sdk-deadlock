...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flFacingTime; // 0x500        
        bool m_bFired; // 0x504        
        [[maybe_unused]] std::uint8_t pad_0x505[0x3]; // 0x505
        entity2::CEntityIOOutput m_OnFacingLookat; // 0x508        
        entity2::CEntityIOOutput m_OnNotFacingLookat; // 0x530        
    ...
    static_assert(sizeof(CPointAngleSensor) == 0x5a8);
};
