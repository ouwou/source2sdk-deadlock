...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::CEntityIOOutput m_PlayerHasAmmo; // 0x4f0        
        entity2::CEntityIOOutput m_PlayerHasNoAmmo; // 0x518        
        entity2::CEntityIOOutput m_PlayerDied; // 0x540        
