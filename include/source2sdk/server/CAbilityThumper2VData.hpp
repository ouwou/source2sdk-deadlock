...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_StompParticle[0xe0]; // 0x1568        
        ...
        char m_BuffModifier[0x10]; // 0x1658        
