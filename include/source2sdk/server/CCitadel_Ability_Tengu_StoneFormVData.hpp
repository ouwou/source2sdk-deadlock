...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_StoneFormParticle[0xe0]; // 0x1728        
        ...
        char m_DragModifier[0x10]; // 0x1838        
        ...
        char m_strTrueFormModel[0xe0]; // 0x1848        
    ...
    static_assert(sizeof(CCitadel_Ability_Tengu_StoneFormVData) == 0x1938);
};
