...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_EscapeModifier[0x10]; // 0x1568        
        ...
        char m_EffectParticle[0xe0]; // 0x1668        
        ...
        char m_ChannelParticle[0xe0]; // 0x1748        
        ...
        char m_RadiusParticle[0xe0]; // 0x1908        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strExpireSound; // 0x19e8        
        // metadata: MPropertyStartGroup "Camera"
        client::CitadelCameraOperationsSequence_t m_cameraSequenceInSatchel; // 0x19f8        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CAbility_Synth_Pulse_VData because it is not a standard-layout class
    static_assert(sizeof(CAbility_Synth_Pulse_VData) == 0x1a80);
};
