...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_BlitzModifier[0x10]; // 0x14f0        
        ...
        char m_TechAmpModifier[0x10]; // 0x1500        
        ...
        char m_SlowParticle[0xe0]; // 0x1510        
    ...
    static_assert(sizeof(CAbility_Synth_Blitz_VData) == 0x1600);
};
