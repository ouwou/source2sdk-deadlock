...
namespace source2sdk::server
{
    ...
    public:
        ...
        server::CCitadelMinimapComponent m_CCitadelMinimapComponent; // 0x878        
        [[maybe_unused]] std::uint8_t pad_0x890[0x8];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Projectile_Guided_Arrow because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Projectile_Guided_Arrow) == 0x898);
};
