...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_WeaponShapeParticle[0xe0]; // 0x1658        
        ...
        char m_WeaponRangeAssistParticle[0xe0]; // 0x1738        
        int32_t m_nNumConePoints; // 0x1818        
        float m_flRoundPerSecond; // 0x181c        
        // metadata: MPropertyGroupName "Modifiers"
        // m_DebuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<server::CCitadelModifier> m_DebuffModifier;
        char m_DebuffModifier[0x10]; // 0x1820        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_PoisonSprayerHitSound; // 0x1830        
        CSoundEventName m_WeaponLoopStartSound; // 0x1840        
        CSoundEventName m_WeaponLoopSound; // 0x1850        
        CSoundEventName m_WeaponLoopEndSound; // 0x1860        
    };
    #pragma pack(pop)
