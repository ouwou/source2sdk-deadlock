...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_HitParticle[0xe0]; // 0x15a0        
        ...
        char m_WeaponShapeParticle[0xe0]; // 0x1680        
        ...
        char m_WeaponRangeAssistParticle[0xe0]; // 0x1760        
        int32_t m_nNumConePoints; // 0x1840        
        float m_flRoundPerSecond; // 0x1844        
        // metadata: MPropertyGroupName "Modifiers"
        // m_DebuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
        // CEmbeddedSubclass<server::CCitadelModifier> m_DebuffModifier;
        char m_DebuffModifier[0x10]; // 0x1848        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_PoisonSprayerHitSound; // 0x1858        
        CSoundEventName m_WeaponLoopStartSound; // 0x1868        
        CSoundEventName m_WeaponLoopSound; // 0x1878        
        CSoundEventName m_WeaponLoopEndSound; // 0x1888        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_PrimaryWeapon_SlorkVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_PrimaryWeapon_SlorkVData) == 0x1898);
};
