...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_vecPuddleModifiers[0x18]; // 0xaf0        
        [[maybe_unused]] std::uint8_t pad_0xb08[0x230]; // 0xb08
        entity2::GameTime_t m_LastDetonateTime; // 0xd38        
    ...
    static_assert(sizeof(CCitadel_Ability_GooGrenade) == 0xd40);
};
