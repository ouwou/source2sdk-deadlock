...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_TracerParticle[0xe0]; // 0x628        
        ...
        char m_SilencerActiveParticle[0xe0]; // 0x708        
