...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_DropoffTimerModifier[0x10]; // 0x1650        
        ...
        char m_HoldingIdolModifier[0x10]; // 0x1660        
        ...
        char m_RevealedHoldingIdolModifier[0x10]; // 0x1670        
        ...
        char m_NoPickupModifier[0x10]; // 0x16a0        
    ...
    static_assert(sizeof(CCitadel_Ability_GoldenIdolVData) == 0x16d0);
};
