...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_pBeamModifier[0x18]; // 0xaf0        
        [[maybe_unused]] std::uint8_t pad_0xb08[0x38]; // 0xb08
        modellib::AttachmentHandle_t m_hAttackPosHigh; // 0xb40        
        modellib::AttachmentHandle_t m_hAttackPosLow; // 0xb41        
        modellib::AttachmentHandle_t m_hAttackPosLeft; // 0xb42        
        modellib::AttachmentHandle_t m_hAttackPosRight; // 0xb43        
    ...
    static_assert(sizeof(CCitadel_Ability_Tier2Boss_LaserBeam) == 0xb48);
};
