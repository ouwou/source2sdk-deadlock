...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_CatchIndicator[0xe0]; // 0x1560        
        ...
        char m_CatchParticle[0xe0]; // 0x1640        
        // metadata: MPropertyStartGroup "Sounds"
        CSoundEventName m_strThrowSound; // 0x1720        
        CSoundEventName m_strReturnSound; // 0x1730        
        CSoundEventName m_strCatchSound; // 0x1740        
        CSoundEventName m_strFailSound; // 0x1750        
        CSoundEventName m_strHitSound; // 0x1760        
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Spinning_BladeVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Spinning_BladeVData) == 0x1770);
};
