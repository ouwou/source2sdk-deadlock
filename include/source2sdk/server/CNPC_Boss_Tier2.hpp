...
namespace source2sdk::server
{
    ...
    public:
        ...
        Vector m_vecStartingPosition; // 0x1808        
        // metadata: MNetworkEnable
        int32_t m_iLane; // 0x1814        
        [[maybe_unused]] std::uint8_t pad_0x1818[0x8]; // 0x1818
        // metadata: MNetworkEnable
        ...
        char m_hTargetedEnemy[0x4]; // 0x1820        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutStart; // 0x1824        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutEnd; // 0x1828        
        [[maybe_unused]] std::uint8_t pad_0x182c[0x24]; // 0x182c
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "coord"
        Vector m_vecElectricBeamLookTarget; // 0x1850        
        // metadata: MNetworkEnable
        int32_t m_nElectricBeamCasts; // 0x185c        
        [[maybe_unused]] std::uint8_t pad_0x1860[0x28]; // 0x1860
        entity2::CEntityIOOutput m_eventOnBossKilled; // 0x1888        
        [[maybe_unused]] std::uint8_t pad_0x18b0[0x40];
