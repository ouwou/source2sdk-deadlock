...
namespace source2sdk::server
{
    ...
    public:
        ...
        int32_t m_iLane; // 0x17cc        
        [[maybe_unused]] std::uint8_t pad_0x17d0[0x8]; // 0x17d0
        // metadata: MNetworkEnable
        ...
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutStart; // 0x17dc        
        // metadata: MNetworkEnable
        entity2::GameTime_t m_flFadeOutEnd; // 0x17e0        
        [[maybe_unused]] std::uint8_t pad_0x17e4[0x24]; // 0x17e4
        // metadata: MNetworkEnable
        // metadata: MNetworkEncoder "coord"
        Vector m_vecElectricBeamLookTarget; // 0x1808        
        // metadata: MNetworkEnable
        int32_t m_nElectricBeamCasts; // 0x1814        
        [[maybe_unused]] std::uint8_t pad_0x1818[0x28]; // 0x1818
        entity2::CEntityIOOutput m_eventOnBossKilled; // 0x1840        
        [[maybe_unused]] std::uint8_t pad_0x1868[0x40];
    ...
    static_assert(sizeof(CNPC_Boss_Tier2) == 0x18a8);
};
