...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x17e8[0x38]; // 0x17e8
        // metadata: MNetworkEnable
        float m_flForwardSpeed; // 0x1820        
        [[maybe_unused]] std::uint8_t pad_0x1824[0x44]; // 0x1824
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CNPC_NanoRollermine) == 0x1870);
};
