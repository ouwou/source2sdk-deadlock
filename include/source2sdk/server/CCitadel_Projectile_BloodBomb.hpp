...
namespace source2sdk::server
{
    ...
    {
    public:
        bool m_bSecondBomb; // 0x878        
        [[maybe_unused]] std::uint8_t pad_0x879[0x3]; // 0x879
        int32_t m_nBeepSoundBuildupCount; // 0x87c        
        float m_flBeepSoundIntervalBias; // 0x880        
        float m_flBeepSoundMaxFrequency; // 0x884        
        float m_flArmingDuration; // 0x888        
