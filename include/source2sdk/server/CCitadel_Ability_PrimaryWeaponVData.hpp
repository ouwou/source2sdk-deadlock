...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1560[0x8]; // 0x1560
        // metadata: MPropertyDescription "The DOF settings to apply while zoomed in."
        client::DOFDesc_t m_DOFWhileZoomed; // 0x1568        
        ...
        [[maybe_unused]] std::uint8_t pad_0x1579[0x7]; // 0x1579
    ...
    static_assert(sizeof(CCitadel_Ability_PrimaryWeaponVData) == 0x15b0);
};
