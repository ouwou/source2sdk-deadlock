...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1528[0x8]; // 0x1528
        // metadata: MPropertyDescription "The DOF settings to apply while zoomed in."
        client::DOFDesc_t m_DOFWhileZoomed; // 0x1530        
        ...
        bool m_bDOFFarSettingsAreOffsetByGunRange; // 0x1540        
        [[maybe_unused]] std::uint8_t pad_0x1541[0x7]; // 0x1541
        // metadata: MPropertyStartGroup "Sounds"
        // metadata: MPropertyFriendlyName "Fire while disarmed sound"
        CSoundEventName m_sDisarmedSound; // 0x1548        
        float m_flMinDisarmedSoundInterval; // 0x1558        
        [[maybe_unused]] std::uint8_t pad_0x155c[0x4]; // 0x155c
        CSoundEventName m_sObstructedShotSound; // 0x1560        
