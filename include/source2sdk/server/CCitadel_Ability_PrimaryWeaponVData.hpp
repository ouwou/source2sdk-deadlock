...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0x1550[0x8]; // 0x1550
        // metadata: MPropertyDescription "The DOF settings to apply while zoomed in."
        client::DOFDesc_t m_DOFWhileZoomed; // 0x1558        
        ...
        bool m_bDOFFarSettingsAreOffsetByGunRange; // 0x1568        
        [[maybe_unused]] std::uint8_t pad_0x1569[0x7]; // 0x1569
        // metadata: MPropertyStartGroup "Sounds"
        // metadata: MPropertyFriendlyName "Fire while disarmed sound"
        CSoundEventName m_sDisarmedSound; // 0x1570        
        float m_flMinDisarmedSoundInterval; // 0x1580        
        [[maybe_unused]] std::uint8_t pad_0x1584[0x4]; // 0x1584
        CSoundEventName m_sObstructedShotSound; // 0x1588        
