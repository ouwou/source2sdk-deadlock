...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_nHitLayerTrigger[0x18]; // 0x810        
        ...
        char m_pszDamageState[0x28]; // 0x828        
    ...
    static_assert(sizeof(CAI_CitadelNPC_GraphController) == 0x918);
};
