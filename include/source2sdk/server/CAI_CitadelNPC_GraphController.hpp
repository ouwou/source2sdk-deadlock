...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_nHitLayerTrigger[0x18]; // 0xaa8        
        ...
        char m_pszDamageState[0x28]; // 0xac0        
    ...
    static_assert(sizeof(CAI_CitadelNPC_GraphController) == 0xbb0);
};
