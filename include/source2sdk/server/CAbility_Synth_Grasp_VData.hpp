...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_CasterModifier[0x10]; // 0x1528        
        ...
        char m_VictimModifier[0x10]; // 0x1538        
