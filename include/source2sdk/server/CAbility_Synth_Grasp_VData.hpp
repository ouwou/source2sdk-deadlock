...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_CasterModifier[0x10]; // 0x1560        
        ...
        char m_VictimModifier[0x10]; // 0x1570        
