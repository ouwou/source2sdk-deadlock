...
namespace source2sdk::server
{
    ...
    {
    public:
        server::EBotTestNodeType m_eNodeType; // 0x4e8        
        ...
        char m_hLockingEntity[0x4]; // 0x508        
    ...
    static_assert(sizeof(CCitadelBotTestNode) == 0x520);
};
