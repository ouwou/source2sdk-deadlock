...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_StageModel[0xe0]; // 0x1550        
        float m_flStageModelHeight; // 0x1630        
        float m_flStageModelWidth; // 0x1634        
        float m_flStageModelLength; // 0x1638        
        float m_flStageModelScale; // 0x163c        
