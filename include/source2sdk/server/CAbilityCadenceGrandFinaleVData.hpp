...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_StageModel[0xe0]; // 0x1528        
        float m_flStageModelHeight; // 0x1608        
        float m_flStageModelWidth; // 0x160c        
        float m_flStageModelLength; // 0x1610        
        float m_flStageModelScale; // 0x1614        
