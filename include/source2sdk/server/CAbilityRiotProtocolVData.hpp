...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_ChargeUpParticle[0xe0]; // 0x1550        
        ...
        char m_CastDelayModifier[0x10]; // 0x1710        
