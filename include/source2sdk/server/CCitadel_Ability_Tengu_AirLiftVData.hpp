...
namespace source2sdk::server
{
    ...
    public:
        ...
        char m_FlyingModifier[0x10]; // 0x1548        
        ...
        char m_GrabModifier[0x10]; // 0x1558        
        ...
        char m_HoldBombModifier[0x10]; // 0x1568        
        ...
        char m_DroppedBuffModifier[0x10]; // 0x1578        
        ...
        char m_ExplodingAllyModifier[0x10]; // 0x1588        
        ...
        char m_AoEModifier[0x10]; // 0x1598        
        ...
        char m_InitialExplodeParticle[0xe0]; // 0x15a8        
        ...
        char m_HoldBombEffect[0xe0]; // 0x1688        
        // metadata: MPropertyGroupName "Sounds"
        CSoundEventName m_strExplodeSound; // 0x1768        
        // metadata: MPropertyStartGroup "Gameplay"
        float m_flAirDrag; // 0x1778        
        float m_flMaxFallSpeed; // 0x177c        
        float m_flTargetAirSpeedFast; // 0x1780        
        float m_flTargetAirSpeedBase; // 0x1784        
        float m_flAcceleration; // 0x1788        
        float m_flDecceleration; // 0x178c        
        float m_flAirSideSpeedPercent; // 0x1790        
        float m_flBoostTime; // 0x1794        
        float m_flBoostSpeedUp; // 0x1798        
        float m_flMinFlyHeight; // 0x179c        
        float m_flMaxFlyHeight; // 0x17a0        
        float m_flMaxPitchUp; // 0x17a4        
        float m_flMaxPitchDown; // 0x17a8        
        float m_flAllyDelayedBoostTime; // 0x17ac        
        float m_flChannelingAirDrag; // 0x17b0        
        float m_flChannelingMaxFallSpeed; // 0x17b4        
        float m_flBombReleaseSpeed; // 0x17b8        
        float m_flBombReleasePitch; // 0x17bc        
        float m_flBombDropReleaseOffset; // 0x17c0        
        float m_flHoldBombOffsetX; // 0x17c4        
        float m_flHoldBombOffsetY; // 0x17c8        
        float m_flHoldBombOffsetZ; // 0x17cc        
        float m_flAnglePitchBias; // 0x17d0        
        float m_flTrackAmount; // 0x17d4        
        float m_flMoveCollideSpeed; // 0x17d8        
        [[maybe_unused]] std::uint8_t pad_0x17dc[0x4];
    };
    #pragma pack(pop)
    
    // Cannot assert offsets of fields in CCitadel_Ability_Tengu_AirLiftVData because it is not a standard-layout class
    static_assert(sizeof(CCitadel_Ability_Tengu_AirLiftVData) == 0x17e0);
};
