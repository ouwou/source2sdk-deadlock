...
namespace source2sdk::server
{
    ...
    {
    public:
        [[maybe_unused]] std::uint8_t pad_0xbc0[0x18]; // 0xbc0
        ...
        char m_hBlockerAura[0x18]; // 0xbf0        
        [[maybe_unused]] std::uint8_t pad_0xc08[0x18]; // 0xc08
    ...
    static_assert(sizeof(CCitadelPayload) == 0xc28);
};
