...
namespace source2sdk::server
{
    ...
    public:
        ...
        entity2::GameTime_t m_flExplodeEndTime; // 0xb68        
        // metadata: MNetworkEnable
        // metadata: MNetworkUserGroup "LocalPlayerOwnerExclusive"
        entity2::GameTime_t m_flBuffEndTime; // 0xb6c        
        client::ParticleIndex_t m_nCastEffect; // 0xb70        
    ...
    static_assert(sizeof(CCitadel_Ability_InfinitySlash) == 0xb78);
};
