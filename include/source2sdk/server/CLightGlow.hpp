...
namespace source2sdk::server
{
    ...
    public:
        ...
        uint32_t m_nHorizontalSize; // 0x7a0        
        // metadata: MNetworkEnable
        uint32_t m_nVerticalSize; // 0x7a4        
        // metadata: MNetworkEnable
        uint32_t m_nMinDist; // 0x7a8        
        // metadata: MNetworkEnable
        uint32_t m_nMaxDist; // 0x7ac        
        // metadata: MNetworkEnable
        uint32_t m_nOuterMaxDist; // 0x7b0        
        // metadata: MNetworkEnable
    ...
    static_assert(sizeof(CLightGlow) == 0x7c0);
};
