...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CBaseModifier> m_AutoChannelModifier; // 0x14b8		
		CEmbeddedSubclass<server::CBaseModifier> m_AutoCastDelayModifier; // 0x14c8		
		CUtlVector<CEmbeddedSubclass<server::CBaseModifier>> m_AutoIntrinsicModifiers; // 0x14d8		
	};
};
