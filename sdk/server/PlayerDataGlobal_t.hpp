...
#include "server/DynamicAbilityValues_t.hpp"
#include "server/ItemImbuementPair_t.hpp"
#include "server/StatViewerModifierValues_t.hpp"
#include <cstdint>
...
namespace source2sdk::server
{
	...
	public:
		...
		CNetworkUtlVectorBase<int32_t> m_vecBonusCounterValues; // 0xc8		
		// MNetworkEnable
		// MNetworkUserGroup "Abilities"
		// MNetworkChangeCallback "pdgUpgradesChanged"
	...
	public:
		// MNetworkEnable
		CUtlVectorEmbeddedNetworkVar<server::ItemImbuementPair_t> m_vecImbuements; // 0xe8		
		// MNetworkEnable
		CUtlVectorEmbeddedNetworkVar<server::DynamicAbilityValues_t> m_vecDynamicAbilityValues; // 0x138		
		// MNetworkEnable
		CUtlVectorEmbeddedNetworkVar<server::StatViewerModifierValues_t> m_vecStatViewerModifierValues; // 0x188		
	};
};
