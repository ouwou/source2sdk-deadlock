...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CBaseModifier> m_LaserBeamModifier; // 0x1408		
		CEmbeddedSubclass<server::CBaseModifier> m_DyingModifier; // 0x1418		
		CEmbeddedSubclass<server::CBaseModifier> m_VulnerableModifier; // 0x1428		
		CEmbeddedSubclass<server::CBaseModifier> m_Phase1Modifier; // 0x1438		
		CEmbeddedSubclass<server::CBaseModifier> m_Phase2Modifier; // 0x1448		
		CEmbeddedSubclass<server::CBaseModifier> m_BackdoorProtection; // 0x1458		
		CEmbeddedSubclass<server::CBaseModifier> m_ObjectiveRegen; // 0x1468		
