...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_BackdoorProtectionModifier; // 0x1608		
		CEmbeddedSubclass<server::CCitadelModifier> m_BackdoorBulletResistModifier; // 0x1618		
		CEmbeddedSubclass<server::CCitadelModifier> m_ObjectiveRegen; // 0x1628		
