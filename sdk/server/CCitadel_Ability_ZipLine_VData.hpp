...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_RidingZipLineModifier; // 0x1b68		
		CEmbeddedSubclass<server::CCitadelModifier> m_KnockedOffSlowModifier; // 0x1b78		
		CEmbeddedSubclass<server::CCitadelModifier> m_ZipLineIntroModifier; // 0x1b88		
		CEmbeddedSubclass<server::CCitadelModifier> m_ZipLineKnockdownImmuneModifier; // 0x1b98		
		CEmbeddedSubclass<server::CCitadelModifier> m_ZipLineSlowModifier; // 0x1ba8		
