...
namespace source2sdk::server
{
	...
	class CAbilityNanoPounceVData : public server::CitadelAbilityVData
	{
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_SlowModifier; // 0x17a0		
		CEmbeddedSubclass<server::CCitadelModifier> m_DebuffModifier; // 0x17b0		
