...
namespace source2sdk::server
{
	...
	public:
		...
		CEmbeddedSubclass<server::CCitadelModifier> m_LeapModifier; // 0x14f0		
		CEmbeddedSubclass<server::CCitadelModifier> m_ActiveBuff; // 0x1500		
		CEmbeddedSubclass<server::CCitadelModifier> m_KillableModifier; // 0x1510		
