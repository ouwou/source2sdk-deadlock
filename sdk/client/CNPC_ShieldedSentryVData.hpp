...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_DeployProgressModifier; // 0x2d0		
		CEmbeddedSubclass<client::CCitadelModifier> m_NearDeathModifier; // 0x2e0		
		CEmbeddedSubclass<client::CCitadelModifier> m_IntrinsicModifier; // 0x2f0		
