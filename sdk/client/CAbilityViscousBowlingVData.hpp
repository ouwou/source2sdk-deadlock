...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_ImpactModifier; // 0x1b90		
		CEmbeddedSubclass<client::CCitadelModifier> m_DamagePreventionModifier; // 0x1ba0		
		CEmbeddedSubclass<client::CCitadelModifier> m_RollingModifier; // 0x1bb0		
