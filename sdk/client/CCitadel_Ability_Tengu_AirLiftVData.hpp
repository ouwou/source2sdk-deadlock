...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_FlyingModifier; // 0x14f0		
		CEmbeddedSubclass<client::CCitadelModifier> m_GrabModifier; // 0x1500		
		CEmbeddedSubclass<client::CCitadelModifier> m_HoldBombModifier; // 0x1510		
		CEmbeddedSubclass<client::CCitadelModifier> m_DroppedBuffModifier; // 0x1520		
		CEmbeddedSubclass<client::CCitadelModifier> m_ExplodingAllyModifier; // 0x1530		
		CEmbeddedSubclass<client::CCitadelModifier> m_AoEModifier; // 0x1540		
