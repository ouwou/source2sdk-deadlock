...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_DisconnectingModifier; // 0x648		
		CEmbeddedSubclass<client::CCitadelModifier> m_DisconnectedModifier; // 0x658		
		CEmbeddedSubclass<client::CCitadelModifier> m_LockedTargetModifier; // 0x668		
