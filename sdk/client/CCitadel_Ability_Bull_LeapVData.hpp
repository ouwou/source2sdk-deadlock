...
namespace source2sdk::client
{
	...
	public:
		...
		CEmbeddedSubclass<client::CCitadelModifier> m_BoostModifier; // 0x1530		
		CEmbeddedSubclass<client::CCitadelModifier> m_CrashModifier; // 0x1540		
		CEmbeddedSubclass<client::CCitadelModifier> m_ImmunityModifier; // 0x1550		
		CEmbeddedSubclass<client::CCitadelModifier> m_LandingBonusesModifier; // 0x1560		
